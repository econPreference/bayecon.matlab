 ...
 *
 * Code generation for function 'Hetero_Regression_emxutil'
 *
 */
...
void emxFreeStruct_struct0_T(const emlrtStack *sp, struct0_T *pStruct)
{
  ...
  emxFree_real_T(sp, &pStruct->lambdam);
}
                             ...
                             const emlrtRTEInfo *srcLocation)
{
  ...
  emxInit_real_T(sp, &pStruct->lambdam, 2, srcLocation);
}
...
/* End of code generation (Hetero_Regression_emxutil.c) */
