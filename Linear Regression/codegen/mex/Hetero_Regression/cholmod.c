                               ...
                               const emxArray_real_T *varargin_1)
{
  ...
  emxEnsureCapacity_real_T(sp, diagA, i, &ad_emlrtRTEI);
                               ...
                               const emxArray_real_T *A)
{
  ...
  emxInit_real_T(sp, &b_A, 2, &mc_emlrtRTEI);
  ...
  emxEnsureCapacity_real_T(sp, b_A, i, &mc_emlrtRTEI);
  b_A_data = b_A->data;
                               ...
                               const emxArray_real_T *A)
{
  ...
  A_data = A->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtCTX)sp);
  emxInit_real_T(sp, &b_A, 2, &lc_emlrtRTEI);
  i = b_A->size[0] * b_A->size[1];
  if (A->size[1] == 1) {
    b_A->size[0] = A->size[0];
  } else {
  ...
  emxEnsureCapacity_real_T(sp, b_A, i, &lc_emlrtRTEI);
  b_A_data = b_A->data;
  stride_0_0 = (A->size[0] != 1);
  stride_0_1 = (A->size[1] != 1);
             ...
             real_T *err)
{
  ...
  if ((A->size[0] != A->size[1]) && ((A->size[0] != 1) && (A->size[1] != 1))) {
    emlrtDimSizeImpxCheckR2021b(A->size[0], A->size[1], &h_emlrtECI,
                                (emlrtCTX)sp);
  }
  if ((A->size[0] != A->size[1]) && ((A->size[1] != 1) && (A->size[0] != 1))) {
    emlrtDimSizeImpxCheckR2021b(A->size[1], A->size[0], &i_emlrtECI,
                                (emlrtCTX)sp);
  }
  emxInit_real_T(sp, &L, 2, &dd_emlrtRTEI);
  emxInit_real_T(sp, &varargin_1, 2, &gd_emlrtRTEI);
  if (A->size[0] == A->size[1]) {
    i = L->size[0] * L->size[1];
    L->size[0] = A->size[0];
    L->size[1] = A->size[1];
    emxEnsureCapacity_real_T(sp, L, i, &lc_emlrtRTEI);
    L_data = L->data;
    loop_ub = A->size[1];
    for (i = 0; i < loop_ub; i++) {
      last = A->size[0];
    ...
    st.site = &t_emlrtRSI;
    f_binary_expand_op(&st, varargin_1, t_emlrtRSI, A);
  }
  emxInit_real_T(sp, &K, 2, &pc_emlrtRTEI);
  st.site = &t_emlrtRSI;
  sum(&st, varargin_1, K);
  st.site = &t_emlrtRSI;
  if (b_sum(&st, K) > 0.0) {
  ...
  emxInit_real_T(sp, &diagA, 1, &cd_emlrtRTEI);
  emxInit_real_T(sp, &b_varargin_1, 1, &fd_emlrtRTEI);
  st.site = &v_emlrtRSI;
  diag(&st, A, diagA);
  st.site = &w_emlrtRSI;
  ...
  if ((A->size[0] != varargin_1->size[0]) &&
    ...
    emlrtDimSizeImpxCheckR2021b(A->size[0], varargin_1->size[0], &j_emlrtECI,
                                (emlrtCTX)sp);
  }
  if ((A->size[1] != varargin_1->size[1]) &&
      ((A->size[1] != 1) && (varargin_1->size[1] != 1))) {
    emlrtDimSizeImpxCheckR2021b(A->size[1], varargin_1->size[1], &k_emlrtECI,
                                (emlrtCTX)sp);
  }
  st.site = &x_emlrtRSI;
  if ((A->size[0] == varargin_1->size[0]) &&
    ...
    L->size[0] = A->size[0];
    L->size[1] = A->size[1];
    emxEnsureCapacity_real_T(&st, L, i, &mc_emlrtRTEI);
    L_data = L->data;
    ...
    b_st.site = &x_emlrtRSI;
    e_binary_expand_op(&b_st, varargin_1, x_emlrtRSI, A);
    diagA_data = varargin_1->data;
  }
  b_st.site = &ac_emlrtRSI;
  c_st.site = &bc_emlrtRSI;
  ...
  emxEnsureCapacity_real_T(&g_st, K, i, &nc_emlrtRTEI);
  K_data = K->data;
  if (varargin_1->size[1] >= 1) {
  ...
  emxInit_real_T(&f_st, &b_d, 1, &oc_emlrtRTEI);
  st.site = &y_emlrtRSI;
  if (b_gamma < 0.0) {
  ...
  i = b_d->size[0];
  b_d->size[0] = n;
  emxEnsureCapacity_real_T(sp, b_d, i, &oc_emlrtRTEI);
  d_data = b_d->data;
  for (i = 0; i < n; i++) {
    d_data[i] = 0.0;
  }
  ...
  emxInit_int32_T(sp, &r, 1, &ed_emlrtRTEI);
  emxInit_real_T(sp, &r1, 1, &wc_emlrtRTEI);
  for (j = 0; j < n; j++) {
    if (j < 1) {
      K->size[0] = 1;
      K->size[1] = 0;
      ...
      K->size[0] = 1;
      K->size[1] = j;
      emxEnsureCapacity_real_T(sp, K, i, &pc_emlrtRTEI);
      K_data = K->data;
      loop_ub = j - 1;
      for (i = 0; i <= loop_ub; i++) {
    ...
    emxEnsureCapacity_real_T(sp, b_varargin_1, i, &rc_emlrtRTEI);
    varargin_1_data = b_varargin_1->data;
    loop_ub = K->size[1];
    for (i = 0; i < loop_ub; i++) {
    ...
    emxEnsureCapacity_real_T(&st, K, i, &tc_emlrtRTEI);
    K_data = K->data;
    loop_ub = b_varargin_1->size[0];
    for (i = 0; i < loop_ub; i++) {
      i1 = (int32_T)varargin_1_data[i];
    ...
    emxEnsureCapacity_real_T(&st, diagA, i, &uc_emlrtRTEI);
    diagA_data = diagA->data;
    loop_ub = b_varargin_1->size[0];
    for (i = 0; i < loop_ub; i++) {
    ...
    if (j + 1 < n) {
      ...
      if ((uint32_T)n < j + 2U) {
        ...
        i1 = n - j;
        K->size[1] = i1 - 1;
        emxEnsureCapacity_real_T(&b_st, K, i, &vc_emlrtRTEI);
        K_data = K->data;
        loop_ub = i1 - 2;
        for (i = 0; i <= loop_ub; i++) {
      ...
      i = r1->size[0];
      r1->size[0] = K->size[1];
      emxEnsureCapacity_real_T(sp, r1, i, &wc_emlrtRTEI);
      r2 = r1->data;
      loop_ub = K->size[1];
      for (i = 0; i < loop_ub; i++) {
        r2[i] = K_data[i];
      ...
      emxEnsureCapacity_real_T(&st, varargin_1, i, &xc_emlrtRTEI);
      diagA_data = varargin_1->data;
      loop_ub = b_varargin_1->size[0];
      for (i = 0; i < loop_ub; i++) {
        last = r1->size[0];
      ...
      i = diagA->size[0];
      diagA->size[0] = b_varargin_1->size[0];
      emxEnsureCapacity_real_T(&st, diagA, i, &yc_emlrtRTEI);
      diagA_data = diagA->data;
      loop_ub = b_varargin_1->size[0];
      for (i = 0; i < loop_ub; i++) {
        last = (int32_T)varargin_1_data[i] - 1;
      ...
      i = r->size[0];
      r->size[0] = r1->size[0];
      emxEnsureCapacity_int32_T(sp, r, i, &bd_emlrtRTEI);
      r3 = r->data;
      loop_ub = r1->size[0];
      for (i = 0; i < loop_ub; i++) {
        i1 = (int32_T)r2[i];
  ...
  for (j = 0; j < n; j++) {
    ...
    emxEnsureCapacity_real_T(sp, b_varargin_1, i, &sc_emlrtRTEI);
    varargin_1_data = b_varargin_1->data;
    for (i = 0; i < loop_ub; i++) {
  ...
  R->size[0] = L->size[1];
  R->size[1] = L->size[0];
  emxEnsureCapacity_real_T(sp, R, i, &qc_emlrtRTEI);
  diagA_data = R->data;
  loop_ub = L->size[0];
  for (i = 0; i < loop_ub; i++) {
    last = L->size[1];
