...
static void b_binary_expand_op(const emlrtStack *sp, emxArray_real_T *Ainv)
{
  ...
  emxInit_real_T(sp, &b_Ainv, 2, &rc_emlrtRTEI);
  ...
  emxEnsureCapacity_real_T(sp, b_Ainv, i, &rc_emlrtRTEI);
  ...
  emxEnsureCapacity_real_T(sp, Ainv, i, &sc_emlrtRTEI);
  Ainv_data = Ainv->data;
           ...
           emxArray_real_T *Ainv)
{
  ...
  if (A->size[0] != A->size[1]) {
    ...
    emxInit_real_T(sp, &Hinv, 2, &vc_emlrtRTEI);
    st.site = &v_emlrtRSI;
    ...
    emxInit_real_T(&st, &b, 1, &uc_emlrtRTEI);
    if (Hinv->size[0] != n) {
      b_y = NULL;
      ...
      while ((!exitg1) && (k <= n - 1)) {
        ...
        if ((b_k < 1) || (b_k > Hinv->size[0])) {
          emlrtDynamicBoundsCheckR2012b(b_k, 1, Hinv->size[0], &ob_emlrtBCI,
                                        &st);
        }
        if (b_k > Hinv->size[1]) {
        ...
        if (d_sum == 0.0) {
          ...
          if (b_k > Hinv->size[0]) {
            emlrtDynamicBoundsCheckR2012b(b_k, 1, Hinv->size[0], &qb_emlrtBCI,
                                          &st);
          }
          if (b_k > Hinv->size[1]) {
            emlrtDynamicBoundsCheckR2012b(b_k, 1, Hinv->size[1], &rb_emlrtBCI,
                                          &st);
          }
          if (b_k > Hinv->size[0]) {
            emlrtDynamicBoundsCheckR2012b(b_k, 1, Hinv->size[0], &sb_emlrtBCI,
                                          &st);
          }
          if (b_k > Hinv->size[1]) {
            emlrtDynamicBoundsCheckR2012b(b_k, 1, Hinv->size[1], &tb_emlrtBCI,
                                          &st);
          }
          Hinv_data[(b_k + Hinv->size[0] * (b_k - 1)) - 1] = 1.0 / d_sum;
          emlrtForLoopVectorCheckR2021a((real_T)b_k - 1.0, -1.0, 1.0,
                                        mxDOUBLE_CLASS, b_k - 1, &d_emlrtRTEI,
                                        &st);
          for (b_i = 0; b_i <= b_k - 2; b_i++) {
            ...
            loop_ub = i1 - i;
            a->size[1] = loop_ub;
            emxEnsureCapacity_real_T(&b_st, a, b_loop_ub, &tc_emlrtRTEI);
            Ainv_data = a->data;
            ...
            i3 = b->size[0];
            b->size[0] = b_loop_ub;
            emxEnsureCapacity_real_T(&b_st, b, i3, &uc_emlrtRTEI);
            b_data = b->data;
    ...
    if ((Ainv->size[0] != Ainv->size[1]) &&
      ...
      emlrtDimSizeImpxCheckR2021b(Ainv->size[0], Ainv->size[1], &i_emlrtECI,
                                  (emlrtCTX)sp);
    }
    if ((Ainv->size[0] != Ainv->size[1]) &&
        ((Ainv->size[1] != 1) && (Ainv->size[0] != 1))) {
      emlrtDimSizeImpxCheckR2021b(Ainv->size[1], Ainv->size[0], &h_emlrtECI,
                                  (emlrtCTX)sp);
    }
    if (Ainv->size[0] == Ainv->size[1]) {
      ...
      emxEnsureCapacity_real_T(sp, Hinv, i, &rc_emlrtRTEI);
      Hinv_data = Hinv->data;
      loop_ub = Ainv->size[1];
      for (i = 0; i < loop_ub; i++) {
        b_loop_ub = Ainv->size[0];
