...
static void m_binary_expand_op(const emlrtStack *sp, emxArray_real_T *A,
                               ...
                               const emxArray_real_T *r1)
{
  ...
  emxEnsureCapacity_real_T(sp, x, i, &hg_emlrtRTEI);
  x_data = x->data;
                               ...
                               const emxArray_real_T *m)
{
  ...
  emxEnsureCapacity_real_T(sp, A, i, &bg_emlrtRTEI);
  A_data = A->data;
                ...
                const emxArray_real_T *m, const emxArray_real_T *C)
{
  ...
  if (C->size[0] != C->size[1]) {
    emlrtErrorWithMessageIdR2018a(&st, &o_emlrtRTEI, "Coder:MATLAB:square",
                                  "Coder:MATLAB:square", 0);
  }
  emxInit_real_T(&st, &b_x, 2, &cg_emlrtRTEI);
  emxInit_int32_T(&st, &ipiv, 2, &jg_emlrtRTEI);
  if ((C->size[0] == 0) || (C->size[1] == 0)) {
    ...
    b_x->size[0] = C->size[0];
    b_x->size[1] = C->size[1];
    emxEnsureCapacity_real_T(&st, b_x, i, &ag_emlrtRTEI);
    b_x_data = b_x->data;
  ...
  if ((x->size[0] != m->size[0]) && ((x->size[0] != 1) && (m->size[0] != 1))) {
    emlrtDimSizeImpxCheckR2021b(x->size[0], m->size[0], &pb_emlrtECI,
                                (emlrtCTX)sp);
  }
  st.site = &pf_emlrtRSI;
  emxInit_real_T(&st, &A, 2, &bg_emlrtRTEI);
  if (x->size[0] == m->size[0]) {
    i = A->size[0] * A->size[1];
    A->size[0] = 1;
    A->size[1] = x->size[0];
    emxEnsureCapacity_real_T(&st, A, i, &bg_emlrtRTEI);
    A_data = A->data;
    loop_ub = x->size[0];
    for (i = 0; i < loop_ub; i++) {
  ...
  emxInit_ptrdiff_t(&b_st, &ipiv_t, &kg_emlrtRTEI);
  emxInit_real_T(&b_st, &r, 1, &lg_emlrtRTEI);
  emxInit_ptrdiff_t(&b_st, &r1, &gg_emlrtRTEI);
  emxInit_real_T(&b_st, &b_A, 1, &dg_emlrtRTEI);
  if ((A->size[1] == 0) || ((C->size[0] == 0) || (C->size[1] == 0))) {
    i = A->size[0] * A->size[1];
    A->size[0] = 1;
    A->size[1] = C->size[0];
    emxEnsureCapacity_real_T(&b_st, A, i, &bg_emlrtRTEI);
    A_data = A->data;
    loop_ub = C->size[0];
    for (i = 0; i < loop_ub; i++) {
      A_data[i] = 0.0;
    ...
    b_x->size[0] = C->size[0];
    b_x->size[1] = C->size[1];
    emxEnsureCapacity_real_T(&f_st, b_x, i, &eg_emlrtRTEI);
    b_x_data = b_x->data;
    loop_ub = C->size[0] * C->size[1];
    for (i = 0; i < loop_ub; i++) {
      b_x_data[i] = C_data[i];
    ...
    emxEnsureCapacity_ptrdiff_t(&g_st, ipiv_t, i, &gg_emlrtRTEI);
    ...
    emxEnsureCapacity_int32_T(&g_st, ipiv, i, &ig_emlrtRTEI);
    ipiv_data = ipiv->data;
    ...
    b_x->size[0] = C->size[1];
    b_x->size[1] = C->size[0];
    emxEnsureCapacity_real_T(&b_st, b_x, i, &cg_emlrtRTEI);
    b_x_data = b_x->data;
    loop_ub = C->size[0];
    for (i = 0; i < loop_ub; i++) {
      n = C->size[1];
    ...
    i = b_A->size[0];
    b_A->size[0] = A->size[1];
    emxEnsureCapacity_real_T(&b_st, b_A, i, &dg_emlrtRTEI);
    b_A_data = b_A->data;
    loop_ub = A->size[1];
    for (i = 0; i < loop_ub; i++) {
      b_A_data[i] = A_data[i];
  ...
  if ((r->size[0] != A->size[1]) && ((A->size[1] != 1) && (r->size[0] != 1))) {
    emlrtDimSizeImpxCheckR2021b(A->size[1], r->size[0], &qb_emlrtECI,
                                (emlrtCTX)sp);
  }
  st.site = &pf_emlrtRSI;
  emxInit_real_T(&st, &c_x, 2, &hg_emlrtRTEI);
  if (r->size[0] == A->size[1]) {
    i = c_x->size[0] * c_x->size[1];
    c_x->size[0] = 1;
    c_x->size[1] = A->size[1];
    emxEnsureCapacity_real_T(&st, c_x, i, &hg_emlrtRTEI);
    b_x_data = c_x->data;
    loop_ub = A->size[1];
    for (i = 0; i < loop_ub; i++) {
  ...
  p = -0.5 * temp -
      muDoubleScalarLog(
          muDoubleScalarPower(6.2831853071795862, (real_T)x->size[0] / 2.0) *
          muDoubleScalarSqrt(muDoubleScalarAbs(y)));
