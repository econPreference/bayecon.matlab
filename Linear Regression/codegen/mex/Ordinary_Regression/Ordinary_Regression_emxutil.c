 ...
 *
 * Ordinary_Regression_emxutil.c
 *
 * Code generation for function 'Ordinary_Regression_emxutil'
 *
 */
                             ...
                             const emlrtRTEInfo *srcLocation)
{
  ...
  emxInit_real_T(sp, &pStruct->R2, 1, srcLocation);
}
...
/* End of code generation (Ordinary_Regression_emxutil.c) */
