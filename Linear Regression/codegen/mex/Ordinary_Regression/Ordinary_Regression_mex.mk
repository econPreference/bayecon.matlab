...
MAKEFILE = Ordinary_Regression_mex.mk

include Ordinary_Regression_mex.mki


SRC_FILES =  \
	Ordinary_Regression_mexutil.c \
	Ordinary_Regression_data.c \
	Ordinary_Regression_initialize.c \
	Ordinary_Regression_terminate.c \
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\Ordinary_Regression"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\Ordinary_Regression/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
