 ...
 *
 * Ordinary_Regression_mexutil.h
 *
 * Code generation for function 'Ordinary_Regression_mexutil'
 *
 */
...
void l_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
                        const emlrtMsgIdentifier *msgId, char_T ret[14]);

/* End of code generation (Ordinary_Regression_mexutil.h) */
