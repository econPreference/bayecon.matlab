...
static void g_binary_expand_op(const emlrtStack *sp, emxArray_real_T *x,
                               const emxArray_real_T *A,
                               const emxArray_real_T *r1);

static void h_binary_expand_op(const emlrtStack *sp, emxArray_real_T *A,
                               ...
                               const emxArray_real_T *r1)
{
  ...
  emxEnsureCapacity_real_T(sp, x, i, &ge_emlrtRTEI);
  x_data = x->data;
                               ...
                               const emxArray_real_T *m)
{
  ...
  emxEnsureCapacity_real_T(sp, A, i, &ae_emlrtRTEI);
  A_data = A->data;
                ...
                const emxArray_real_T *m, const emxArray_real_T *C)
{
  ...
  emxInit_real_T(&st, &b_x, 2, &be_emlrtRTEI);
  emxInit_int32_T(&st, &ipiv, 2, &ie_emlrtRTEI);
  if ((C->size[0] == 0) || (C->size[1] == 0)) {
    ...
    b_x->size[0] = C->size[0];
    b_x->size[1] = C->size[1];
    emxEnsureCapacity_real_T(&st, b_x, i, &yd_emlrtRTEI);
    b_x_data = b_x->data;
  ...
  if ((x->size[0] != m->size[0]) && ((x->size[0] != 1) && (m->size[0] != 1))) {
    emlrtDimSizeImpxCheckR2021b(x->size[0], m->size[0], &t_emlrtECI,
                                (emlrtCTX)sp);
  }
  st.site = &gf_emlrtRSI;
  emxInit_real_T(&st, &A, 2, &ae_emlrtRTEI);
  if (x->size[0] == m->size[0]) {
    i = A->size[0] * A->size[1];
    A->size[0] = 1;
    A->size[1] = x->size[0];
    emxEnsureCapacity_real_T(&st, A, i, &ae_emlrtRTEI);
    A_data = A->data;
    loop_ub = x->size[0];
    for (i = 0; i < loop_ub; i++) {
  ...
  emxInit_ptrdiff_t(&b_st, &ipiv_t, &je_emlrtRTEI);
  emxInit_real_T(&b_st, &r, 1, &ke_emlrtRTEI);
  emxInit_ptrdiff_t(&b_st, &r1, &fe_emlrtRTEI);
  emxInit_real_T(&b_st, &b_A, 1, &ce_emlrtRTEI);
  if ((A->size[1] == 0) || ((C->size[0] == 0) || (C->size[1] == 0))) {
    i = A->size[0] * A->size[1];
    A->size[0] = 1;
    A->size[1] = C->size[0];
    emxEnsureCapacity_real_T(&b_st, A, i, &ae_emlrtRTEI);
    A_data = A->data;
    loop_ub = C->size[0];
    for (i = 0; i < loop_ub; i++) {
      A_data[i] = 0.0;
    ...
    b_x->size[0] = C->size[0];
    b_x->size[1] = C->size[1];
    emxEnsureCapacity_real_T(&f_st, b_x, i, &de_emlrtRTEI);
    b_x_data = b_x->data;
    loop_ub = C->size[0] * C->size[1];
    for (i = 0; i < loop_ub; i++) {
      b_x_data[i] = C_data[i];
    ...
    emxEnsureCapacity_ptrdiff_t(&g_st, ipiv_t, i, &fe_emlrtRTEI);
    ...
    emxEnsureCapacity_int32_T(&g_st, ipiv, i, &he_emlrtRTEI);
    ipiv_data = ipiv->data;
    ...
    b_x->size[0] = C->size[1];
    b_x->size[1] = C->size[0];
    emxEnsureCapacity_real_T(&b_st, b_x, i, &be_emlrtRTEI);
    b_x_data = b_x->data;
    loop_ub = C->size[0];
    for (i = 0; i < loop_ub; i++) {
      n = C->size[1];
    ...
    i = b_A->size[0];
    b_A->size[0] = A->size[1];
    emxEnsureCapacity_real_T(&b_st, b_A, i, &ce_emlrtRTEI);
    b_A_data = b_A->data;
    loop_ub = A->size[1];
    for (i = 0; i < loop_ub; i++) {
      b_A_data[i] = A_data[i];
  ...
  if ((r->size[0] != A->size[1]) && ((A->size[1] != 1) && (r->size[0] != 1))) {
    emlrtDimSizeImpxCheckR2021b(A->size[1], r->size[0], &s_emlrtECI,
                                (emlrtCTX)sp);
  }
  st.site = &gf_emlrtRSI;
  emxInit_real_T(&st, &d_x, 2, &ge_emlrtRTEI);
  if (r->size[0] == A->size[1]) {
    i = d_x->size[0] * d_x->size[1];
    d_x->size[0] = 1;
    d_x->size[1] = A->size[1];
    emxEnsureCapacity_real_T(&st, d_x, i, &ge_emlrtRTEI);
    b_x_data = d_x->data;
    loop_ub = A->size[1];
    for (i = 0; i < loop_ub; i++) {
    ...
    b_st.site = &gf_emlrtRSI;
    g_binary_expand_op(&b_st, d_x, A, r);
  }
  emxFree_real_T(&st, &r);
  emxFree_real_T(&st, &A);
