...
{
  emxInit_real_T(&pStruct->mum, 2);
  emxInit_real_T(&pStruct->Sm, 2);
  emxInit_real_T2(&pStruct->Sigmam, 3);
  emxInit_real_T(&pStruct->Xa, 2);
  emxInit_real_T(&pStruct->Ya, 2);
  emxInit_real_T(&pStruct->Omega_hat, 2);
...
/*
 * File trailer for Mixture_Normal_emxutil.c
 *
 * [EOF]
 */
