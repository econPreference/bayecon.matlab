 ...
 * File: _coder_Mixture_Normal_mex.c
 *
...
static void Mixture_Normal_mexFunction(int32_T nlhs, mxArray *plhs[1], int32_T
  ...
  nrhs, const mxArray *prhs[8])
{
  ...
  /* Call the function. */
  Mixture_Normal_api(prhs, nlhs, outputs);
...
/*
 * File trailer for _coder_Mixture_Normal_mex.c
 *
 * [EOF]
 */
