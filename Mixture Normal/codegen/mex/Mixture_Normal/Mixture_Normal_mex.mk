...
MAKEFILE = Mixture_Normal_mex.mk

include Mixture_Normal_mex.mki


SRC_FILES =  \
	Mixture_Normal_mexutil.c \
	Mixture_Normal_data.c \
	Mixture_Normal_initialize.c \
	Mixture_Normal_terminate.c \
	Mixture_Normal.c \
	...
	randwishart.c \
	vec.c \
	_coder_Mixture_Normal_info.c \
	_coder_Mixture_Normal_api.c \
	_coder_Mixture_Normal_mex.c \
	Mixture_Normal_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = Mixture_Normal_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\Mixture_Normal"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\Mixture_Normal/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
