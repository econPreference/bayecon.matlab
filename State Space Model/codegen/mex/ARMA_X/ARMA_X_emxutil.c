 ...
 * ARMA_X_emxutil.c
 *
 * Code generation for function 'ARMA_X_emxutil'
 *
 */
                             ...
                             const emlrtRTEInfo *srcLocation)
{
  ...
  emxInit_real_T(sp, &pStruct->Vm, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->betam, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->phim, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->thetam, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->sig2m, 1, srcLocation);
  emxInit_real_T(sp, &pStruct->phi_0, 1, srcLocation);
}
...
/* End of code generation (ARMA_X_emxutil.c) */
