...
static void d_binary_expand_op(const emlrtStack *sp, emxArray_real_T *diagA,
                               ...
                               const emxArray_real_T *varargin_1)
{
  ...
  emxEnsureCapacity_real_T(sp, diagA, i, &ie_emlrtRTEI);
                               ...
                               const emxArray_real_T *A)
{
  ...
  emxInit_real_T(sp, &b_A, 2, &ud_emlrtRTEI);
  ...
  emxEnsureCapacity_real_T(sp, b_A, i, &ud_emlrtRTEI);
  b_A_data = b_A->data;
               ...
               emxArray_real_T *R)
{
  ...
  if ((A->size[0] != A->size[1]) && ((A->size[0] != 1) && (A->size[1] != 1))) {
    emlrtDimSizeImpxCheckR2021b(A->size[0], A->size[1], &l_emlrtECI,
                                (emlrtCTX)sp);
  }
  if ((A->size[0] != A->size[1]) && ((A->size[1] != 1) && (A->size[0] != 1))) {
    emlrtDimSizeImpxCheckR2021b(A->size[1], A->size[0], &m_emlrtECI,
                                (emlrtCTX)sp);
  }
  emxInit_real_T(sp, &L, 2, &le_emlrtRTEI);
  emxInit_real_T(sp, &varargin_1, 2, &oe_emlrtRTEI);
  if (A->size[0] == A->size[1]) {
    i = L->size[0] * L->size[1];
    L->size[0] = A->size[0];
    L->size[1] = A->size[1];
    emxEnsureCapacity_real_T(sp, L, i, &td_emlrtRTEI);
    L_data = L->data;
    loop_ub = A->size[1];
    for (i = 0; i < loop_ub; i++) {
      last = A->size[0];
    ...
    st.site = &rb_emlrtRSI;
    f_binary_expand_op(&st, varargin_1, rb_emlrtRSI, A);
  }
  emxInit_real_T(sp, &K, 2, &xd_emlrtRTEI);
  st.site = &rb_emlrtRSI;
  sum(&st, varargin_1, K);
  st.site = &rb_emlrtRSI;
  if (b_sum(&st, K) > 0.0) {
  ...
  emxInit_real_T(sp, &diagA, 1, &ke_emlrtRTEI);
  emxInit_real_T(sp, &b_varargin_1, 1, &ne_emlrtRTEI);
  st.site = &tb_emlrtRSI;
  diag(&st, A, diagA);
  st.site = &ub_emlrtRSI;
  ...
  if ((A->size[0] != varargin_1->size[0]) &&
    ...
    emlrtDimSizeImpxCheckR2021b(A->size[0], varargin_1->size[0], &n_emlrtECI,
                                (emlrtCTX)sp);
  }
  if ((A->size[1] != varargin_1->size[1]) &&
      ((A->size[1] != 1) && (varargin_1->size[1] != 1))) {
    emlrtDimSizeImpxCheckR2021b(A->size[1], varargin_1->size[1], &o_emlrtECI,
                                (emlrtCTX)sp);
  }
  st.site = &vb_emlrtRSI;
  if ((A->size[0] == varargin_1->size[0]) &&
    ...
    L->size[0] = A->size[0];
    L->size[1] = A->size[1];
    emxEnsureCapacity_real_T(&st, L, i, &ud_emlrtRTEI);
    L_data = L->data;
    ...
    b_st.site = &vb_emlrtRSI;
    e_binary_expand_op(&b_st, varargin_1, vb_emlrtRSI, A);
    diagA_data = varargin_1->data;
  }
  b_st.site = &kc_emlrtRSI;
  c_st.site = &lc_emlrtRSI;
  ...
  emxEnsureCapacity_real_T(&g_st, K, i, &vd_emlrtRTEI);
  K_data = K->data;
  if (varargin_1->size[1] >= 1) {
  ...
  emxInit_real_T(&f_st, &b_d, 1, &wd_emlrtRTEI);
  st.site = &wb_emlrtRSI;
  if (b_gamma < 0.0) {
  ...
  i = b_d->size[0];
  b_d->size[0] = n;
  emxEnsureCapacity_real_T(sp, b_d, i, &wd_emlrtRTEI);
  d_data = b_d->data;
  for (i = 0; i < n; i++) {
    d_data[i] = 0.0;
  }
  ...
  emxInit_int32_T(sp, &r, 1, &me_emlrtRTEI);
  emxInit_real_T(sp, &r1, 1, &fe_emlrtRTEI);
  for (j = 0; j < n; j++) {
    if (j < 1) {
      K->size[0] = 1;
      K->size[1] = 0;
      ...
      K->size[0] = 1;
      K->size[1] = j;
      emxEnsureCapacity_real_T(sp, K, i, &xd_emlrtRTEI);
      K_data = K->data;
      loop_ub = j - 1;
      for (i = 0; i <= loop_ub; i++) {
    ...
    emxEnsureCapacity_real_T(&st, K, i, &ce_emlrtRTEI);
    K_data = K->data;
    loop_ub = b_varargin_1->size[0];
    for (i = 0; i < loop_ub; i++) {
      i1 = (int32_T)varargin_1_data[i];
    ...
    emxEnsureCapacity_real_T(&st, diagA, i, &de_emlrtRTEI);
    diagA_data = diagA->data;
    loop_ub = b_varargin_1->size[0];
    for (i = 0; i < loop_ub; i++) {
    ...
    if (j + 1 < n) {
      ...
      if ((uint32_T)n < j + 2U) {
        ...
        i1 = n - j;
        K->size[1] = i1 - 1;
        emxEnsureCapacity_real_T(&b_st, K, i, &ee_emlrtRTEI);
        K_data = K->data;
        loop_ub = i1 - 2;
        for (i = 0; i <= loop_ub; i++) {
      ...
      i = r1->size[0];
      r1->size[0] = K->size[1];
      emxEnsureCapacity_real_T(sp, r1, i, &fe_emlrtRTEI);
      r2 = r1->data;
      loop_ub = K->size[1];
      for (i = 0; i < loop_ub; i++) {
        r2[i] = K_data[i];
      ...
      emxEnsureCapacity_real_T(&st, varargin_1, i, &ge_emlrtRTEI);
      diagA_data = varargin_1->data;
      loop_ub = b_varargin_1->size[0];
      for (i = 0; i < loop_ub; i++) {
        last = r1->size[0];
      ...
      i = diagA->size[0];
      diagA->size[0] = b_varargin_1->size[0];
      emxEnsureCapacity_real_T(&st, diagA, i, &he_emlrtRTEI);
      diagA_data = diagA->data;
      loop_ub = b_varargin_1->size[0];
      for (i = 0; i < loop_ub; i++) {
        last = (int32_T)varargin_1_data[i] - 1;
      ...
      if (r1->size[0] == b_varargin_1->size[0]) {
        ...
        st.site = &bc_emlrtRSI;
        d_binary_expand_op(&st, diagA, A, r1, j, b_varargin_1);
        diagA_data = diagA->data;
      }
      /*  C(I,j) in book */
      st.site = &cc_emlrtRSI;
      ...
      i = r->size[0];
      r->size[0] = r1->size[0];
      emxEnsureCapacity_int32_T(sp, r, i, &je_emlrtRTEI);
      r3 = r->data;
      loop_ub = r1->size[0];
      for (i = 0; i < loop_ub; i++) {
        i1 = (int32_T)r2[i];
  ...
  for (j = 0; j < n; j++) {
    ...
    emxEnsureCapacity_real_T(sp, b_varargin_1, i, &be_emlrtRTEI);
    varargin_1_data = b_varargin_1->data;
    for (i = 0; i < loop_ub; i++) {
