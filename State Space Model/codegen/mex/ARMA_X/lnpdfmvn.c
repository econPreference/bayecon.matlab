                    ...
                    const emxArray_real_T *x, const emxArray_real_T *m)
{
  ...
  emxEnsureCapacity_real_T(sp, r1, i, &kk_emlrtRTEI);
  r = r1->data;
                               ...
                               const emxArray_real_T *r1)
{
  ...
  emxEnsureCapacity_real_T(sp, x, i, &mk_emlrtRTEI);
  x_data = x->data;
                               ...
                               const emxArray_real_T *m)
{
  ...
  emxEnsureCapacity_real_T(sp, A, i, &gk_emlrtRTEI);
  A_data = A->data;
                  ...
                  const emxArray_real_T *m, const emxArray_real_T *C)
{
  ...
  if (C->size[0] != C->size[1]) {
    emlrtErrorWithMessageIdR2018a(&st, &cb_emlrtRTEI, "Coder:MATLAB:square",
                                  "Coder:MATLAB:square", 0);
  }
  emxInit_real_T(&st, &b_x, 2, &hk_emlrtRTEI);
  emxInit_int32_T(&st, &ipiv, 2, &ok_emlrtRTEI);
  if ((C->size[0] == 0) || (C->size[1] == 0)) {
    ...
    b_x->size[0] = C->size[0];
    b_x->size[1] = C->size[1];
    emxEnsureCapacity_real_T(&st, b_x, i, &fk_emlrtRTEI);
    b_x_data = b_x->data;
  ...
  if ((x->size[0] != m->size[0]) && ((x->size[0] != 1) && (m->size[0] != 1))) {
    emlrtDimSizeImpxCheckR2021b(x->size[0], m->size[0], &pc_emlrtECI,
                                (emlrtCTX)sp);
  }
  st.site = &bg_emlrtRSI;
  emxInit_real_T(&st, &A, 2, &gk_emlrtRTEI);
  if (x->size[0] == m->size[0]) {
    i = A->size[0] * A->size[1];
    A->size[0] = 1;
    A->size[1] = x->size[0];
    emxEnsureCapacity_real_T(&st, A, i, &gk_emlrtRTEI);
    A_data = A->data;
    loop_ub = x->size[0];
    for (i = 0; i < loop_ub; i++) {
  ...
  if (C->size[1] != A->size[1]) {
    emlrtErrorWithMessageIdR2018a(&st, &db_emlrtRTEI, "MATLAB:dimagree",
                                  "MATLAB:dimagree", 0);
  }
  b_st.site = &lj_emlrtRSI;
  emxInit_ptrdiff_t(&b_st, &ipiv_t, &pk_emlrtRTEI);
  emxInit_real_T(&b_st, &r, 1, &qk_emlrtRTEI);
  emxInit_ptrdiff_t(&b_st, &r1, &lk_emlrtRTEI);
  emxInit_real_T(&b_st, &b_A, 1, &ik_emlrtRTEI);
  if ((A->size[1] == 0) || ((C->size[0] == 0) || (C->size[1] == 0))) {
    i = A->size[0] * A->size[1];
    A->size[0] = 1;
    A->size[1] = C->size[0];
    emxEnsureCapacity_real_T(&b_st, A, i, &gk_emlrtRTEI);
    A_data = A->data;
    loop_ub = C->size[0];
    for (i = 0; i < loop_ub; i++) {
      A_data[i] = 0.0;
    ...
    b_x->size[0] = C->size[0];
    b_x->size[1] = C->size[1];
    emxEnsureCapacity_real_T(&f_st, b_x, i, &jk_emlrtRTEI);
    b_x_data = b_x->data;
    loop_ub = C->size[0] * C->size[1];
    for (i = 0; i < loop_ub; i++) {
      b_x_data[i] = C_data[i];
    ...
    emxEnsureCapacity_ptrdiff_t(&g_st, ipiv_t, i, &lk_emlrtRTEI);
    ...
    emxEnsureCapacity_int32_T(&g_st, ipiv, i, &nk_emlrtRTEI);
    ipiv_data = ipiv->data;
    h_st.site = &lf_emlrtRSI;
    if (n < 0) {
      if (n == -1010) {
        emlrtErrorWithMessageIdR2018a(&h_st, &v_emlrtRTEI, "MATLAB:nomem",
                                      "MATLAB:nomem", 0);
      } else {
        emlrtErrorWithMessageIdR2018a(
            &h_st, &u_emlrtRTEI, "Coder:toolbox:LAPACKCallErrorInfo",
    ...
    b_x->size[0] = C->size[1];
    b_x->size[1] = C->size[0];
    emxEnsureCapacity_real_T(&b_st, b_x, i, &hk_emlrtRTEI);
    b_x_data = b_x->data;
    loop_ub = C->size[0];
    for (i = 0; i < loop_ub; i++) {
      n = C->size[1];
    ...
    i = b_A->size[0];
    b_A->size[0] = A->size[1];
    emxEnsureCapacity_real_T(&b_st, b_A, i, &ik_emlrtRTEI);
    b_A_data = b_A->data;
    loop_ub = A->size[1];
    for (i = 0; i < loop_ub; i++) {
      b_A_data[i] = A_data[i];
  ...
  if ((r->size[0] != A->size[1]) && ((A->size[1] != 1) && (r->size[0] != 1))) {
    emlrtDimSizeImpxCheckR2021b(A->size[1], r->size[0], &oc_emlrtECI,
                                (emlrtCTX)sp);
  }
  st.site = &bg_emlrtRSI;
  emxInit_real_T(&st, &d_x, 2, &mk_emlrtRTEI);
  if (r->size[0] == A->size[1]) {
    i = d_x->size[0] * d_x->size[1];
    d_x->size[0] = 1;
    d_x->size[1] = A->size[1];
    emxEnsureCapacity_real_T(&st, d_x, i, &mk_emlrtRTEI);
    b_x_data = d_x->data;
    loop_ub = A->size[1];
    for (i = 0; i < loop_ub; i++) {
    ...
    b_st.site = &bg_emlrtRSI;
    q_binary_expand_op(&b_st, d_x, A, r);
  }
  emxFree_real_T(&st, &r);
  emxFree_real_T(&st, &A);
