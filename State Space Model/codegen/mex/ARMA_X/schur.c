...
void schur(const emlrtStack *sp, emxArray_real_T *A)
{
  ...
  if (anyNonFinite(&st, A)) {
    ...
    A->size[0] = A_idx_1;
    A->size[1] = n;
    emxEnsureCapacity_real_T(sp, A, i, &hl_emlrtRTEI);
    A_data = A->data;
    for (i = 0; i < n; i++) {
      for (j = 0; j < A_idx_1; j++) {
    ...
    emxInit_real_T(sp, &tau, 1, &nl_emlrtRTEI);
    st.site = &mh_emlrtRSI;
    ...
    emxEnsureCapacity_real_T(&b_st, tau, i, &il_emlrtRTEI);
    wr_data = tau->data;
    if (A->size[0] > 1) {
      ...
      if (p) {
        ...
        A->size[0] = istart;
        A->size[1] = A_idx_1;
        emxEnsureCapacity_real_T(&b_st, A, i, &kl_emlrtRTEI);
        A_data = A->data;
        for (i = 0; i < A_idx_1; i++) {
          for (j = 0; j < istart; j++) {
            A_data[j + A->size[0] * i] = rtNaN;
    ...
    if ((A->size[0] != 0) && (A->size[1] != 0)) {
      emxInit_real_T(&b_st, &wr, 2, &ol_emlrtRTEI);
      emxInit_real_T(&b_st, &wi, 2, &pl_emlrtRTEI);
      A_idx_1 = A->size[0];
      i = wr->size[0] * wr->size[1];
      wr->size[0] = 1;
      wr->size[1] = A_idx_1;
      emxEnsureCapacity_real_T(&b_st, wr, i, &jl_emlrtRTEI);
      wr_data = wr->data;
      i = wi->size[0] * wi->size[1];
      wi->size[0] = 1;
      wi->size[1] = A_idx_1;
      emxEnsureCapacity_real_T(&b_st, wi, i, &ll_emlrtRTEI);
      wi_data = wi->data;
      ...
      if (p) {
        ...
        A->size[0] = istart;
        A->size[1] = A_idx_1;
        emxEnsureCapacity_real_T(&b_st, A, i, &ml_emlrtRTEI);
        A_data = A->data;
        for (i = 0; i < A_idx_1; i++) {
          for (j = 0; j < istart; j++) {
            A_data[j + A->size[0] * i] = rtNaN;
