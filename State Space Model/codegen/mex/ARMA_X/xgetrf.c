            ...
            int32_T lda, emxArray_int32_T *ipiv)
{
  ...
  if ((A->size[0] == 0) || (A->size[1] == 0)) {
    ...
    emxInit_ptrdiff_t(&st, &ipiv_t, &pk_emlrtRTEI);
    emxInit_ptrdiff_t(&st, &r, &lk_emlrtRTEI);
    ...
    emxEnsureCapacity_ptrdiff_t(&st, ipiv_t, i, &lk_emlrtRTEI);
    ...
    emxEnsureCapacity_int32_T(&st, ipiv, i, &nk_emlrtRTEI);
    ipiv_data = ipiv->data;
    b_st.site = &lf_emlrtRSI;
    emxFree_ptrdiff_t(&b_st, &r);
    if (info < 0) {
      if (info == -1010) {
        emlrtErrorWithMessageIdR2018a(&b_st, &v_emlrtRTEI, "MATLAB:nomem",
                                      "MATLAB:nomem", 0);
      } else {
        emlrtErrorWithMessageIdR2018a(
            &b_st, &u_emlrtRTEI, "Coder:toolbox:LAPACKCallErrorInfo",
            "Coder:toolbox:LAPACKCallErrorInfo", 5, 4, 19, &cv2[0], 12, info);
      }
    }
    i = ipiv_t->size[0] - 1;
