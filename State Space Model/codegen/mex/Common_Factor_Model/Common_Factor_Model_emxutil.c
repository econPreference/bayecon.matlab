 ...
 *
 * Common_Factor_Model_emxutil.c
 *
 * Code generation for function 'Common_Factor_Model_emxutil'
 *
 */
...
{
  emxFree_real_T(sp, &pStruct->Hm);
  emxFree_real_T(sp, &pStruct->betam);
  emxFree_real_T(sp, &pStruct->sig2m);
  emxFree_real_T(sp, &pStruct->Gm);
  emxFree_real_T(sp, &pStruct->mum);
  emxFree_real_T(sp, &pStruct->sig2vm);
  emxFree_real_T(sp, &pStruct->decomm);
}
...
void emxInitStruct_struct0_T(const emlrtStack *sp, struct0_T *pStruct,
                             const emlrtRTEInfo *srcLocation)
{
  emxInit_real_T(sp, &pStruct->Hm, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->betam, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->sig2m, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->Gm, 1, srcLocation);
  emxInit_real_T(sp, &pStruct->mum, 1, srcLocation);
  emxInit_real_T(sp, &pStruct->sig2vm, 1, srcLocation);
  emxInit_real_T(sp, &pStruct->decomm, 2, srcLocation);
}
...
/* End of code generation (Common_Factor_Model_emxutil.c) */
