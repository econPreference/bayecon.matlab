...
void emxFreeStruct_struct0_T(const emlrtStack *sp, struct0_T *pStruct)
{
  ...
  emxFree_real_T(sp, &pStruct->gammam);
  emxFree_real_T(sp, &pStruct->Sig2m);
  emxFree_real_T(sp, &pStruct->Volm);
}
                             ...
                             const emlrtRTEInfo *srcLocation)
{
  ...
  emxInit_real_T(sp, &pStruct->gammam, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->Sig2m, 1, srcLocation);
  emxInit_real_T(sp, &pStruct->Volm, 2, srcLocation);
}
