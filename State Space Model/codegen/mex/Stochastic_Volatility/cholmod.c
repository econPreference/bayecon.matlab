                               ...
                               const emxArray_real_T *varargin_1)
{
  ...
  emxEnsureCapacity_real_T(sp, diagA, i, &ue_emlrtRTEI);
                               ...
                               const emxArray_real_T *A)
{
  ...
  emxInit_real_T(sp, &b_A, 2, &he_emlrtRTEI);
  ...
  emxEnsureCapacity_real_T(sp, b_A, i, &he_emlrtRTEI);
  b_A_data = b_A->data;
                               ...
                               const emxArray_real_T *A)
{
  ...
  A_data = A->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtCTX)sp);
  emxInit_real_T(sp, &b_A, 2, &ge_emlrtRTEI);
  i = b_A->size[0] * b_A->size[1];
  if (A->size[1] == 1) {
    b_A->size[0] = A->size[0];
  } else {
  ...
  emxEnsureCapacity_real_T(sp, b_A, i, &ge_emlrtRTEI);
  b_A_data = b_A->data;
  stride_0_0 = (A->size[0] != 1);
  stride_0_1 = (A->size[1] != 1);
               ...
               emxArray_real_T *R)
{
  ...
  if ((A->size[0] != A->size[1]) && ((A->size[0] != 1) && (A->size[1] != 1))) {
    emlrtDimSizeImpxCheckR2021b(A->size[0], A->size[1], &y_emlrtECI,
                                (emlrtCTX)sp);
  }
  if ((A->size[0] != A->size[1]) && ((A->size[1] != 1) && (A->size[0] != 1))) {
    emlrtDimSizeImpxCheckR2021b(A->size[1], A->size[0], &ab_emlrtECI,
                                (emlrtCTX)sp);
  }
  emxInit_real_T(sp, &L, 2, &xe_emlrtRTEI);
  emxInit_real_T(sp, &varargin_1, 2, &bf_emlrtRTEI);
  if (A->size[0] == A->size[1]) {
    i = L->size[0] * L->size[1];
    L->size[0] = A->size[0];
    L->size[1] = A->size[1];
    emxEnsureCapacity_real_T(sp, L, i, &ge_emlrtRTEI);
    L_data = L->data;
    loop_ub = A->size[1];
    for (i = 0; i < loop_ub; i++) {
      last = A->size[0];
    ...
    st.site = &hd_emlrtRSI;
    g_binary_expand_op(&st, varargin_1, hd_emlrtRSI, A);
  }
  emxInit_real_T(sp, &K, 2, &ke_emlrtRTEI);
  st.site = &hd_emlrtRSI;
  sum(&st, varargin_1, K);
  st.site = &hd_emlrtRSI;
  if (b_sum(&st, K) > 0.0) {
  ...
  emxInit_real_T(sp, &diagA, 1, &we_emlrtRTEI);
  emxInit_real_T(sp, &b_varargin_1, 1, &af_emlrtRTEI);
  st.site = &jd_emlrtRSI;
  diag(&st, A, diagA);
  st.site = &kd_emlrtRSI;
  ...
  if ((A->size[0] != varargin_1->size[0]) &&
    ...
    emlrtDimSizeImpxCheckR2021b(A->size[0], varargin_1->size[0], &bb_emlrtECI,
                                (emlrtCTX)sp);
  }
  if ((A->size[1] != varargin_1->size[1]) &&
      ((A->size[1] != 1) && (varargin_1->size[1] != 1))) {
    emlrtDimSizeImpxCheckR2021b(A->size[1], varargin_1->size[1], &cb_emlrtECI,
                                (emlrtCTX)sp);
  }
  st.site = &ld_emlrtRSI;
  if ((A->size[0] == varargin_1->size[0]) &&
    ...
    L->size[0] = A->size[0];
    L->size[1] = A->size[1];
    emxEnsureCapacity_real_T(&st, L, i, &he_emlrtRTEI);
    L_data = L->data;
    ...
    b_st.site = &ld_emlrtRSI;
    f_binary_expand_op(&b_st, varargin_1, ld_emlrtRSI, A);
    diagA_data = varargin_1->data;
  }
  b_st.site = &oe_emlrtRSI;
  c_st.site = &pe_emlrtRSI;
  ...
  emxEnsureCapacity_real_T(&g_st, K, i, &ie_emlrtRTEI);
  K_data = K->data;
  if (varargin_1->size[1] >= 1) {
  ...
  emxInit_real_T(&f_st, &b_d, 1, &je_emlrtRTEI);
  st.site = &md_emlrtRSI;
  if (b_gamma < 0.0) {
  ...
  i = b_d->size[0];
  b_d->size[0] = n;
  emxEnsureCapacity_real_T(sp, b_d, i, &je_emlrtRTEI);
  d_data = b_d->data;
  for (i = 0; i < n; i++) {
    d_data[i] = 0.0;
  }
  ...
  emxInit_int32_T(sp, &r, 1, &ye_emlrtRTEI);
  emxInit_real_T(sp, &r1, 1, &re_emlrtRTEI);
  for (j = 0; j < n; j++) {
    if (j < 1) {
      K->size[0] = 1;
      K->size[1] = 0;
      ...
      K->size[0] = 1;
      K->size[1] = j;
      emxEnsureCapacity_real_T(sp, K, i, &ke_emlrtRTEI);
      K_data = K->data;
      loop_ub = j - 1;
      for (i = 0; i <= loop_ub; i++) {
    ...
    emxEnsureCapacity_real_T(sp, b_varargin_1, i, &me_emlrtRTEI);
    varargin_1_data = b_varargin_1->data;
    loop_ub = K->size[1];
    for (i = 0; i < loop_ub; i++) {
    ...
    for (i = 0; i < loop_ub; i++) {
      ...
      if (varargin_1_data[i] != i1) {
        emlrtIntegerCheckR2012b(varargin_1_data[i], &p_emlrtDCI, (emlrtCTX)sp);
      }
      if (i1 > b_d->size[0]) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, b_d->size[0], &ec_emlrtBCI,
                                      (emlrtCTX)sp);
      }
    }
    if (j + 1 > L->size[0]) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, L->size[0], &hc_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    loop_ub = b_varargin_1->size[0];
    for (i = 0; i < loop_ub; i++) {
      i1 = (int32_T)varargin_1_data[i];
      if (i1 > L->size[1]) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, L->size[1], &dc_emlrtBCI,
                                      (emlrtCTX)sp);
      }
    }
    st.site = &od_emlrtRSI;
    if (j + 1 > L->size[0]) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, L->size[0], &gc_emlrtBCI, &st);
    }
    i = K->size[0] * K->size[1];
    K->size[0] = 1;
    K->size[1] = b_varargin_1->size[0];
    emxEnsureCapacity_real_T(&st, K, i, &oe_emlrtRTEI);
    K_data = K->data;
    loop_ub = b_varargin_1->size[0];
    for (i = 0; i < loop_ub; i++) {
      i1 = (int32_T)varargin_1_data[i];
    ...
    emxEnsureCapacity_real_T(&st, diagA, i, &pe_emlrtRTEI);
    diagA_data = diagA->data;
    loop_ub = b_varargin_1->size[0];
    for (i = 0; i < loop_ub; i++) {
    ...
    c_dynamic_size_checks(&b_st, K, diagA, b_varargin_1->size[0],
                          diagA->size[0]);
    if (j + 1 > A->size[1]) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, A->size[1], &ac_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    if (j + 1 > A->size[0]) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, A->size[0], &bc_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    ...
    if (j + 1 < n) {
      ...
      if ((uint32_T)n < j + 2U) {
        ...
        i1 = n - j;
        K->size[1] = i1 - 1;
        emxEnsureCapacity_real_T(&b_st, K, i, &qe_emlrtRTEI);
        K_data = K->data;
        loop_ub = i1 - 2;
        for (i = 0; i <= loop_ub; i++) {
      ...
      if (j + 1 > L->size[0]) {
        emlrtDynamicBoundsCheckR2012b(j + 1, 1, L->size[0], &jc_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      loop_ub = b_varargin_1->size[0];
      for (i = 0; i < loop_ub; i++) {
      ...
      i = r1->size[0];
      r1->size[0] = K->size[1];
      emxEnsureCapacity_real_T(sp, r1, i, &re_emlrtRTEI);
      r2 = r1->data;
      loop_ub = K->size[1];
      for (i = 0; i < loop_ub; i++) {
        r2[i] = K_data[i];
      ...
      for (i = 0; i < loop_ub; i++) {
        i1 = (int32_T)r2[i];
        if (r2[i] != i1) {
          emlrtIntegerCheckR2012b(r2[i], &o_emlrtDCI, (emlrtCTX)sp);
        }
        if ((i1 < 1) || (i1 > A->size[0])) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, A->size[0], &vb_emlrtBCI,
                                        (emlrtCTX)sp);
        }
      }
      if (j + 1 > A->size[1]) {
      ...
      emxEnsureCapacity_real_T(&st, varargin_1, i, &se_emlrtRTEI);
      diagA_data = varargin_1->data;
      loop_ub = b_varargin_1->size[0];
      for (i = 0; i < loop_ub; i++) {
        last = r1->size[0];
      ...
      i = diagA->size[0];
      diagA->size[0] = b_varargin_1->size[0];
      emxEnsureCapacity_real_T(&st, diagA, i, &te_emlrtRTEI);
      diagA_data = diagA->data;
      loop_ub = b_varargin_1->size[0];
      for (i = 0; i < loop_ub; i++) {
        last = (int32_T)varargin_1_data[i] - 1;
      ...
      b_st.site = &sb_emlrtRSI;
      dynamic_size_checks(&b_st, varargin_1, diagA, b_varargin_1->size[0],
                          diagA->size[0]);
      b_st.site = &rb_emlrtRSI;
      mtimes(&b_st, varargin_1, diagA, b_varargin_1);
      varargin_1_data = b_varargin_1->data;
      ...
      i = r->size[0];
      r->size[0] = r1->size[0];
      emxEnsureCapacity_int32_T(sp, r, i, &ve_emlrtRTEI);
      r3 = r->data;
      loop_ub = r1->size[0];
      for (i = 0; i < loop_ub; i++) {
        i1 = (int32_T)r2[i];
      ...
      if (j + 1 > L->size[1]) {
        emlrtDynamicBoundsCheckR2012b(j + 1, 1, L->size[1], &kc_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      if (j + 1 > b_d->size[0]) {
        emlrtDynamicBoundsCheckR2012b(j + 1, 1, b_d->size[0], &qb_emlrtBCI,
                                      (emlrtCTX)sp);
      }
    ...
    if (j + 1 > b_d->size[0]) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, b_d->size[0], &lc_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  ...
  for (j = 0; j < n; j++) {
    if (j + 1 > L->size[1]) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, L->size[1], &mc_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    if (j + 1 > b_d->size[0]) {
    ...
    emxEnsureCapacity_real_T(sp, b_varargin_1, i, &ne_emlrtRTEI);
    varargin_1_data = b_varargin_1->data;
    for (i = 0; i < loop_ub; i++) {
  ...
  R->size[0] = L->size[1];
  R->size[1] = L->size[0];
  emxEnsureCapacity_real_T(sp, R, i, &le_emlrtRTEI);
  diagA_data = R->data;
  loop_ub = L->size[0];
  for (i = 0; i < loop_ub; i++) {
    last = L->size[1];
