 ...
 *
 * Code generation for function 'Time_Varying_Parameter_emxutil'
 *
 */
...
void emxFreeStruct_struct0_T(const emlrtStack *sp, struct0_T *pStruct)
{
  ...
  emxFree_real_T(sp, &pStruct->Omegam);
  emxFree_real_T(sp, &pStruct->Sigmam);
  emxFree_real_T(sp, &pStruct->beta1m);
}
                             ...
                             const emlrtRTEInfo *srcLocation)
{
  ...
  emxInit_real_T(sp, &pStruct->Omegam, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->Sigmam, 1, srcLocation);
  emxInit_real_T(sp, &pStruct->beta1m, 3, srcLocation);
}
...
/* End of code generation (Time_Varying_Parameter_emxutil.c) */
