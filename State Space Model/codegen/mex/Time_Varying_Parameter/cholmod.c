...
static void j_binary_expand_op(const emlrtStack *sp, emxArray_real_T *diagA,
...
static void l_binary_expand_op(const emlrtStack *sp,
                               emxArray_real_T *varargin_1,
                               emlrtRSInfo om_emlrtRSI,
                               const emxArray_real_T *A);
                               ...
                               const emxArray_real_T *A)
{
  ...
  emxInit_real_T(sp, &b_A, 2, &le_emlrtRTEI);
  ...
  emxEnsureCapacity_real_T(sp, b_A, i, &le_emlrtRTEI);
  b_A_data = b_A->data;
                               ...
                               const emxArray_real_T *A)
{
  ...
  A_data = A->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtCTX)sp);
  emxInit_real_T(sp, &b_A, 2, &ke_emlrtRTEI);
  i = b_A->size[0] * b_A->size[1];
  if (A->size[1] == 1) {
    b_A->size[0] = A->size[0];
  } else {
  ...
  emxEnsureCapacity_real_T(sp, b_A, i, &ke_emlrtRTEI);
  b_A_data = b_A->data;
  stride_0_0 = (A->size[0] != 1);
  stride_0_1 = (A->size[1] != 1);
               ...
               emxArray_real_T *R, real_T *err)
{
  ...
  if ((A->size[0] != A->size[1]) && ((A->size[0] != 1) && (A->size[1] != 1))) {
    emlrtDimSizeImpxCheckR2021b(A->size[0], A->size[1], &fb_emlrtECI,
                                (emlrtCTX)sp);
  }
  if ((A->size[0] != A->size[1]) && ((A->size[1] != 1) && (A->size[0] != 1))) {
    emlrtDimSizeImpxCheckR2021b(A->size[1], A->size[0], &gb_emlrtECI,
                                (emlrtCTX)sp);
  }
  emxInit_real_T(sp, &L, 2, &cf_emlrtRTEI);
  emxInit_real_T(sp, &varargin_1, 2, &ff_emlrtRTEI);
  if (A->size[0] == A->size[1]) {
    ...
    st.site = &yc_emlrtRSI;
    l_binary_expand_op(&st, varargin_1, yc_emlrtRSI, A);
  }
  emxInit_real_T(sp, &K, 2, &oe_emlrtRTEI);
  st.site = &yc_emlrtRSI;
  b_sum(&st, varargin_1, K);
  st.site = &yc_emlrtRSI;
  if (c_sum(&st, K) > 0.0) {
    st.site = &ad_emlrtRSI;
    b_error(&st);
  ...
  emxInit_real_T(sp, &diagA, 1, &bf_emlrtRTEI);
  emxInit_real_T(sp, &b_varargin_1, 1, &ef_emlrtRTEI);
  st.site = &yd_emlrtRSI;
  diag(&st, A, diagA);
  st.site = &ae_emlrtRSI;
  ...
  if ((A->size[0] != varargin_1->size[0]) &&
    ...
    emlrtDimSizeImpxCheckR2021b(A->size[0], varargin_1->size[0], &hb_emlrtECI,
                                (emlrtCTX)sp);
  }
  if ((A->size[1] != varargin_1->size[1]) &&
      ((A->size[1] != 1) && (varargin_1->size[1] != 1))) {
    emlrtDimSizeImpxCheckR2021b(A->size[1], varargin_1->size[1], &ib_emlrtECI,
                                (emlrtCTX)sp);
  }
  st.site = &be_emlrtRSI;
  if ((A->size[0] == varargin_1->size[0]) &&
    ...
    L->size[0] = A->size[0];
    L->size[1] = A->size[1];
    emxEnsureCapacity_real_T(&st, L, i, &le_emlrtRTEI);
    L_data = L->data;
    ...
    b_st.site = &be_emlrtRSI;
    k_binary_expand_op(&b_st, varargin_1, be_emlrtRSI, A);
    diagA_data = varargin_1->data;
  }
  b_st.site = &me_emlrtRSI;
  c_st.site = &ne_emlrtRSI;
  ...
  emxEnsureCapacity_real_T(&g_st, K, i, &me_emlrtRTEI);
  K_data = K->data;
  if (varargin_1->size[1] >= 1) {
  ...
  emxInit_real_T(&f_st, &b_d, 1, &ne_emlrtRTEI);
  st.site = &bd_emlrtRSI;
  if (b_gamma < 0.0) {
  ...
  i = b_d->size[0];
  b_d->size[0] = n;
  emxEnsureCapacity_real_T(sp, b_d, i, &ne_emlrtRTEI);
  d_data = b_d->data;
  for (i = 0; i < n; i++) {
    d_data[i] = 0.0;
  }
  ...
  emxInit_int32_T(sp, &r, 1, &df_emlrtRTEI);
  ...
  for (j = 0; j < n; j++) {
    if (j < 1) {
      ...
      K->size[0] = 1;
      K->size[1] = j;
      emxEnsureCapacity_real_T(sp, K, i, &oe_emlrtRTEI);
      K_data = K->data;
      loop_ub = j - 1;
      for (i = 0; i <= loop_ub; i++) {
    ...
    emxEnsureCapacity_real_T(sp, b_varargin_1, i, &qe_emlrtRTEI);
    varargin_1_data = b_varargin_1->data;
    loop_ub = K->size[1];
    for (i = 0; i < loop_ub; i++) {
    ...
    st.site = &de_emlrtRSI;
    if (j + 1 > L->size[0]) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, L->size[0], &ub_emlrtBCI, &st);
    }
    i = K->size[0] * K->size[1];
    K->size[0] = 1;
    K->size[1] = b_varargin_1->size[0];
    emxEnsureCapacity_real_T(&st, K, i, &se_emlrtRTEI);
    K_data = K->data;
    loop_ub = b_varargin_1->size[0];
    for (i = 0; i < loop_ub; i++) {
      i1 = (int32_T)varargin_1_data[i];
    ...
    djtemp = A_data[j + A->size[0] * j] - e_mtimes(K, diagA);
    /*  C(j,j) in book */
    if (j + 1 < n) {
      st.site = &ee_emlrtRSI;
      ...
      if ((uint32_T)n < j + 2U) {
        ...
        i1 = n - j;
        K->size[1] = i1 - 1;
        emxEnsureCapacity_real_T(&b_st, K, i, &ue_emlrtRTEI);
        K_data = K->data;
        loop_ub = i1 - 2;
        for (i = 0; i <= loop_ub; i++) {
      ...
      i = r1->size[0];
      r1->size[0] = K->size[1];
      emxEnsureCapacity_real_T(sp, r1, i, &ve_emlrtRTEI);
      r2 = r1->data;
      loop_ub = K->size[1];
      for (i = 0; i < loop_ub; i++) {
        r2[i] = K_data[i];
      ...
      if (j + 1 > A->size[1]) {
        emlrtDynamicBoundsCheckR2012b(j + 1, 1, A->size[1], &wb_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      st.site = &fe_emlrtRSI;
      ...
      emxEnsureCapacity_real_T(&st, varargin_1, i, &we_emlrtRTEI);
      diagA_data = varargin_1->data;
      loop_ub = b_varargin_1->size[0];
      for (i = 0; i < loop_ub; i++) {
        last = r1->size[0];
      ...
      i = diagA->size[0];
      diagA->size[0] = b_varargin_1->size[0];
      emxEnsureCapacity_real_T(&st, diagA, i, &xe_emlrtRTEI);
      diagA_data = diagA->data;
      loop_ub = b_varargin_1->size[0];
      for (i = 0; i < loop_ub; i++) {
        last = (int32_T)varargin_1_data[i] - 1;
      ...
      if (r1->size[0] == b_varargin_1->size[0]) {
        ...
        st.site = &fe_emlrtRSI;
        j_binary_expand_op(&st, diagA, A, r1, j, b_varargin_1);
        diagA_data = diagA->data;
      }
      /*  C(I,j) in book */
      st.site = &ge_emlrtRSI;
      ...
      if (b_varargin_1->size[0] < 1) {
        emlrtErrorWithMessageIdR2018a(
            &d_st, &i_emlrtRTEI, "Coder:toolbox:eml_min_or_max_varDimZero",
            "Coder:toolbox:eml_min_or_max_varDimZero", 0);
      }
      e_st.site = &pe_emlrtRSI;
      f_st.site = &qe_emlrtRSI;
      ...
      i = r->size[0];
      r->size[0] = r1->size[0];
      emxEnsureCapacity_int32_T(sp, r, i, &af_emlrtRTEI);
      r3 = r->data;
      loop_ub = r1->size[0];
      for (i = 0; i < loop_ub; i++) {
        i1 = (int32_T)r2[i];
    ...
    if (j + 1 > b_d->size[0]) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, b_d->size[0], &ac_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  ...
  for (j = 0; j < n; j++) {
    ...
    if (j + 1 > b_d->size[0]) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, b_d->size[0], &tb_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    theta = d_data[j];
    st.site = &cd_emlrtRSI;
    ...
    emxEnsureCapacity_real_T(sp, b_varargin_1, i, &re_emlrtRTEI);
    varargin_1_data = b_varargin_1->data;
    for (i = 0; i < loop_ub; i++) {
  ...
  R->size[0] = L->size[1];
  R->size[1] = L->size[0];
  emxEnsureCapacity_real_T(sp, R, i, &pe_emlrtRTEI);
  diagA_data = R->data;
  loop_ub = L->size[0];
  for (i = 0; i < loop_ub; i++) {
    last = L->size[1];
...
void cholmod(const emlrtStack *sp, const emxArray_real_T *A, emxArray_real_T *R)
{
  ...
  if (idx != 0) {
    b_gamma = c_varargin_1[idx - 1];
    i = idx + 1;
    for (loop_ub = i; loop_ub < 4; loop_ub++) {
      d = c_varargin_1[loop_ub - 1];
      if (b_gamma < d) {
        b_gamma = d;
      }
  ...
  emxInit_real_T(sp, &b_d, 1, &ne_emlrtRTEI);
  st.site = &bd_emlrtRSI;
  if (b_gamma < 0.0) {
    emlrtErrorWithMessageIdR2018a(
        &st, &t_emlrtRTEI, "Coder:toolbox:ElFunDomainError",
