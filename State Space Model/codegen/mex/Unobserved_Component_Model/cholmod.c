...
static void f_binary_expand_op(const emlrtStack *sp, emxArray_real_T *diagA,
                               ...
                               const emxArray_real_T *varargin_1)
{
  ...
  emxEnsureCapacity_real_T(sp, diagA, i, &qe_emlrtRTEI);
                               ...
                               const emxArray_real_T *A)
{
  ...
  emxInit_real_T(sp, &b_A, 2, &de_emlrtRTEI);
  ...
  emxEnsureCapacity_real_T(sp, b_A, i, &de_emlrtRTEI);
  b_A_data = b_A->data;
                               ...
                               const emxArray_real_T *A)
{
  ...
  A_data = A->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtCTX)sp);
  emxInit_real_T(sp, &b_A, 2, &ce_emlrtRTEI);
  i = b_A->size[0] * b_A->size[1];
  if (A->size[1] == 1) {
    b_A->size[0] = A->size[0];
  } else {
  ...
  emxEnsureCapacity_real_T(sp, b_A, i, &ce_emlrtRTEI);
  b_A_data = b_A->data;
  stride_0_0 = (A->size[0] != 1);
  stride_0_1 = (A->size[1] != 1);
               ...
               emxArray_real_T *R, real_T *err)
{
  ...
  if ((A->size[0] != A->size[1]) && ((A->size[0] != 1) && (A->size[1] != 1))) {
    emlrtDimSizeImpxCheckR2021b(A->size[0], A->size[1], &bb_emlrtECI,
                                (emlrtCTX)sp);
  }
  if ((A->size[0] != A->size[1]) && ((A->size[1] != 1) && (A->size[0] != 1))) {
    emlrtDimSizeImpxCheckR2021b(A->size[1], A->size[0], &cb_emlrtECI,
                                (emlrtCTX)sp);
  }
  emxInit_real_T(sp, &L, 2, &te_emlrtRTEI);
  emxInit_real_T(sp, &varargin_1, 2, &we_emlrtRTEI);
  if (A->size[0] == A->size[1]) {
    i = L->size[0] * L->size[1];
    L->size[0] = A->size[0];
    L->size[1] = A->size[1];
    emxEnsureCapacity_real_T(sp, L, i, &ce_emlrtRTEI);
    L_data = L->data;
    loop_ub = A->size[1];
    for (i = 0; i < loop_ub; i++) {
      last = A->size[0];
    ...
    st.site = &md_emlrtRSI;
    h_binary_expand_op(&st, varargin_1, md_emlrtRSI, A);
  }
  emxInit_real_T(sp, &K, 2, &ge_emlrtRTEI);
  st.site = &md_emlrtRSI;
  sum(&st, varargin_1, K);
  st.site = &md_emlrtRSI;
  if (b_sum(&st, K) > 0.0) {
  ...
  emxInit_real_T(sp, &diagA, 1, &se_emlrtRTEI);
  emxInit_real_T(sp, &b_varargin_1, 1, &ve_emlrtRTEI);
  st.site = &od_emlrtRSI;
  b_diag(&st, A, diagA);
  st.site = &pd_emlrtRSI;
  ...
  if ((A->size[0] != varargin_1->size[0]) &&
    ...
    emlrtDimSizeImpxCheckR2021b(A->size[0], varargin_1->size[0], &db_emlrtECI,
                                (emlrtCTX)sp);
  }
  if ((A->size[1] != varargin_1->size[1]) &&
      ((A->size[1] != 1) && (varargin_1->size[1] != 1))) {
    emlrtDimSizeImpxCheckR2021b(A->size[1], varargin_1->size[1], &eb_emlrtECI,
                                (emlrtCTX)sp);
  }
  st.site = &qd_emlrtRSI;
  if ((A->size[0] == varargin_1->size[0]) &&
    ...
    L->size[0] = A->size[0];
    L->size[1] = A->size[1];
    emxEnsureCapacity_real_T(&st, L, i, &de_emlrtRTEI);
    L_data = L->data;
    ...
    b_st.site = &qd_emlrtRSI;
    g_binary_expand_op(&b_st, varargin_1, qd_emlrtRSI, A);
    diagA_data = varargin_1->data;
  }
  b_st.site = &he_emlrtRSI;
  c_st.site = &ie_emlrtRSI;
  ...
  emxEnsureCapacity_real_T(&g_st, K, i, &ee_emlrtRTEI);
  K_data = K->data;
  if (varargin_1->size[1] >= 1) {
  ...
  emxInit_real_T(&f_st, &b_d, 1, &fe_emlrtRTEI);
  st.site = &rd_emlrtRSI;
  if (b_gamma < 0.0) {
  ...
  i = b_d->size[0];
  b_d->size[0] = n;
  emxEnsureCapacity_real_T(sp, b_d, i, &fe_emlrtRTEI);
  d_data = b_d->data;
  for (i = 0; i < n; i++) {
    d_data[i] = 0.0;
  }
  ...
  emxInit_int32_T(sp, &r, 1, &ue_emlrtRTEI);
  emxInit_real_T(sp, &r1, 1, &ne_emlrtRTEI);
  for (j = 0; j < n; j++) {
    if (j < 1) {
      K->size[0] = 1;
      K->size[1] = 0;
      ...
      K->size[0] = 1;
      K->size[1] = j;
      emxEnsureCapacity_real_T(sp, K, i, &ge_emlrtRTEI);
      K_data = K->data;
      loop_ub = j - 1;
      for (i = 0; i <= loop_ub; i++) {
    ...
    emxEnsureCapacity_real_T(sp, b_varargin_1, i, &ie_emlrtRTEI);
    varargin_1_data = b_varargin_1->data;
    loop_ub = K->size[1];
    for (i = 0; i < loop_ub; i++) {
    ...
    for (i = 0; i < loop_ub; i++) {
      ...
      if (varargin_1_data[i] != i1) {
        emlrtIntegerCheckR2012b(varargin_1_data[i], &cb_emlrtDCI, (emlrtCTX)sp);
      }
      if (i1 > b_d->size[0]) {
    ...
    emxEnsureCapacity_real_T(&st, K, i, &ke_emlrtRTEI);
    K_data = K->data;
    loop_ub = b_varargin_1->size[0];
    for (i = 0; i < loop_ub; i++) {
      i1 = (int32_T)varargin_1_data[i];
    ...
    emxEnsureCapacity_real_T(&st, diagA, i, &le_emlrtRTEI);
    diagA_data = diagA->data;
    loop_ub = b_varargin_1->size[0];
    for (i = 0; i < loop_ub; i++) {
    ...
    e_dynamic_size_checks(&b_st, K, diagA, b_varargin_1->size[0],
                          diagA->size[0]);
    if (j + 1 > A->size[1]) {
    ...
    if (j + 1 < n) {
      ...
      if ((uint32_T)n < j + 2U) {
        ...
        i1 = n - j;
        K->size[1] = i1 - 1;
        emxEnsureCapacity_real_T(&b_st, K, i, &me_emlrtRTEI);
        K_data = K->data;
        loop_ub = i1 - 2;
        for (i = 0; i <= loop_ub; i++) {
      ...
      for (i = 0; i < loop_ub; i++) {
        i1 = (int32_T)r2[i];
        if (r2[i] != i1) {
          emlrtIntegerCheckR2012b(r2[i], &bb_emlrtDCI, (emlrtCTX)sp);
        }
        if ((i1 < 1) || (i1 > A->size[0])) {
      ...
      emxEnsureCapacity_real_T(&st, varargin_1, i, &oe_emlrtRTEI);
      diagA_data = varargin_1->data;
      loop_ub = b_varargin_1->size[0];
      for (i = 0; i < loop_ub; i++) {
        last = r1->size[0];
      ...
      if (r1->size[0] == b_varargin_1->size[0]) {
        ...
        st.site = &vd_emlrtRSI;
        f_binary_expand_op(&st, diagA, A, r1, j, b_varargin_1);
        diagA_data = diagA->data;
      }
      /*  C(I,j) in book */
      st.site = &wd_emlrtRSI;
      ...
      i = r->size[0];
      r->size[0] = r1->size[0];
      emxEnsureCapacity_int32_T(sp, r, i, &re_emlrtRTEI);
      r3 = r->data;
      loop_ub = r1->size[0];
      for (i = 0; i < loop_ub; i++) {
        i1 = (int32_T)r2[i];
  ...
  for (j = 0; j < n; j++) {
    ...
    emxEnsureCapacity_real_T(sp, b_varargin_1, i, &je_emlrtRTEI);
    varargin_1_data = b_varargin_1->data;
    for (i = 0; i < loop_ub; i++) {
  ...
  R->size[0] = L->size[1];
  R->size[1] = L->size[0];
  emxEnsureCapacity_real_T(sp, R, i, &he_emlrtRTEI);
  diagA_data = R->data;
  loop_ub = L->size[0];
  for (i = 0; i < loop_ub; i++) {
    last = L->size[1];
