function Plot_accumul_IRF(ImpulseRespm,postmom_B)
...
figure('Name','Accumulated Impulse-Response Analysis([2.5%, 50%, 97.5%])');
zeroline = zeros(mlag1,1);


for i = 1:k2
    
    ImpulseResp_ij = cumsum(ImpulseRespm(:,:,i),2); % n1 by (mlag+1) i번째 모수에 대한 값을 빼옴
