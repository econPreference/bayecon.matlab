...
{
  emxInit_real_T1(sp, &pStruct->Yfm, 1, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->Vm, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->betam, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->phim, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->thetam, 2, srcLocation, doPush);
  emxInit_real_T1(sp, &pStruct->sig2m, 1, srcLocation, doPush);
  emxInit_real_T1(sp, &pStruct->phi_0, 1, srcLocation, doPush);
}
