...
real_T emlrt_marshallIn(const emlrtStack *sp, const mxArray *e_feval, const
  char_T *identifier)
{
  real_T y;
  ...
  y = b_emlrt_marshallIn(sp, emlrtAlias(e_feval), &thisId);
  emlrtDestroyArray(&e_feval);
  return y;
}

real_T m_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
