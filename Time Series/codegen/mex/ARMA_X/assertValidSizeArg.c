...
void assertValidSizeArg(const emlrtStack *sp, real_T varargin_1)
{
  ...
  if ((!(varargin_1 != varargin_1)) && (!(varargin_1 > 2.147483647E+9))) {
    ...
    emlrtErrorWithMessageIdR2018a(sp, &po_emlrtRTEI,
  ...
  if (!(b_varargin_1 <= 2.147483647E+9)) {
    emlrtErrorWithMessageIdR2018a(sp, &qo_emlrtRTEI, "Coder:MATLAB:pmaxsize",
