...
static emlrtRSInfo ab_emlrtRSI = { 172,/* lineNo */
  "combineVectorElements",             /* fcnName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\datafun\\private\\combineVectorElements.m"/* pathName */
};

static emlrtRSInfo bb_emlrtRSI = { 193,/* lineNo */
  "combineVectorElements",             /* fcnName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\datafun\\private\\combineVectorElements.m"/* pathName */
};

static emlrtRTEInfo wc_emlrtRTEI = { 134,/* lineNo */
  13,                                  /* colNo */
...
real_T b_colMajorFlatIter(const emlrtStack *sp, const emxArray_real_T *x,
  int32_T vlen)
{
  real_T y;
  int32_T k;
  ...
  emxArray_real_T *y)
{
  ...
  if ((x->size[0] == 0) || (x->size[1] == 0)) {
    ...
    emxEnsureCapacity_real_T(sp, y, xpageoffset, &xc_emlrtRTEI);
    i = (int32_T)sz[1];
    ...
    y->size[0] = 1;
    y->size[1] = x->size[1];
    emxEnsureCapacity_real_T(&st, y, xpageoffset, &wc_emlrtRTEI);
