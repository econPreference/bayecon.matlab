...
static void g_binary_expand_op(const emlrtStack *sp, emxArray_real_T *Ainv);
...
static void g_binary_expand_op(const emlrtStack *sp, emxArray_real_T *Ainv)
{
  ...
  emxInit_real_T(sp, &b_Ainv, 2, &ne_emlrtRTEI);
  ...
  emxEnsureCapacity_real_T(sp, b_Ainv, i, &ne_emlrtRTEI);
  ...
  emxEnsureCapacity_real_T(sp, Ainv, i, &pe_emlrtRTEI);
  Ainv_data = Ainv->data;
           ...
           emxArray_real_T *Ainv)
{
  ...
  if (A->size[0] != A->size[1]) {
    ...
    emxInit_real_T(sp, &Hinv, 2, &se_emlrtRTEI);
    st.site = &kb_emlrtRSI;
    ...
    /* output : Matrix T */
    n = Hinv->size[1];
    emxInit_real_T(&st, &a, 2, &qe_emlrtRTEI);
    emxInit_real_T(&st, &b, 1, &re_emlrtRTEI);
    if (Hinv->size[0] != n) {
      b_y = NULL;
      ...
      while ((!exitg1) && (k <= n - 1)) {
        ...
        if ((b_k < 1) || (b_k > Hinv->size[0])) {
          emlrtDynamicBoundsCheckR2012b(b_k, 1, Hinv->size[0], &ub_emlrtBCI,
                                        &st);
        }
        if (b_k > Hinv->size[1]) {
          emlrtDynamicBoundsCheckR2012b(b_k, 1, Hinv->size[1], &vb_emlrtBCI,
                                        &st);
        }
        ...
        if (d_sum == 0.0) {
          ...
          if (b_k > Hinv->size[0]) {
            emlrtDynamicBoundsCheckR2012b(b_k, 1, Hinv->size[0], &wb_emlrtBCI,
                                          &st);
          }
          if (b_k > Hinv->size[1]) {
            emlrtDynamicBoundsCheckR2012b(b_k, 1, Hinv->size[1], &xb_emlrtBCI,
                                          &st);
          }
          if (b_k > Hinv->size[0]) {
            emlrtDynamicBoundsCheckR2012b(b_k, 1, Hinv->size[0], &yb_emlrtBCI,
                                          &st);
          }
          if (b_k > Hinv->size[1]) {
            emlrtDynamicBoundsCheckR2012b(b_k, 1, Hinv->size[1], &ac_emlrtBCI,
                                          &st);
          }
          Hinv_data[(b_k + Hinv->size[0] * (b_k - 1)) - 1] = 1.0 / d_sum;
          emlrtForLoopVectorCheckR2021a((real_T)b_k - 1.0, -1.0, 1.0,
                                        mxDOUBLE_CLASS, b_k - 1, &h_emlrtRTEI,
                                        &st);
          for (b_i = 0; b_i <= b_k - 2; b_i++) {
            ...
            loop_ub = i1 - i;
            a->size[1] = loop_ub;
            emxEnsureCapacity_real_T(&b_st, a, b_loop_ub, &qe_emlrtRTEI);
            Ainv_data = a->data;
            ...
            if (b_k > Hinv->size[1]) {
              emlrtDynamicBoundsCheckR2012b(b_k, 1, Hinv->size[1], &ob_emlrtBCI,
                                            &b_st);
            }
            b_loop_ub = i3 - i2;
            i3 = b->size[0];
            b->size[0] = b_loop_ub;
            emxEnsureCapacity_real_T(&b_st, b, i3, &re_emlrtRTEI);
            b_data = b->data;
            ...
            if (b_k > Hinv->size[1]) {
              emlrtDynamicBoundsCheckR2012b(b_k, 1, Hinv->size[1], &ec_emlrtBCI,
                                            &st);
            }
    ...
    if ((Hinv->size[0] == 0) || (Hinv->size[1] == 0)) {
      ...
      emxEnsureCapacity_real_T(&b_st, Ainv, i, &me_emlrtRTEI);
      Ainv_data = Ainv->data;
      ...
      Ainv->size[0] = Hinv->size[0];
      Ainv->size[1] = Hinv->size[0];
      emxEnsureCapacity_real_T(&d_st, Ainv, i, &oe_emlrtRTEI);
      Ainv_data = Ainv->data;
    ...
    if ((Ainv->size[0] != Ainv->size[1]) &&
      ...
      emlrtDimSizeImpxCheckR2021b(Ainv->size[0], Ainv->size[1], &p_emlrtECI,
                                  (emlrtCTX)sp);
    }
    if ((Ainv->size[0] != Ainv->size[1]) &&
        ((Ainv->size[1] != 1) && (Ainv->size[0] != 1))) {
      emlrtDimSizeImpxCheckR2021b(Ainv->size[1], Ainv->size[0], &q_emlrtECI,
                                  (emlrtCTX)sp);
    }
    if (Ainv->size[0] == Ainv->size[1]) {
      ...
      emxEnsureCapacity_real_T(sp, Hinv, i, &ne_emlrtRTEI);
      Hinv_data = Hinv->data;
      loop_ub = Ainv->size[1];
      for (i = 0; i < loop_ub; i++) {
        b_loop_ub = Ainv->size[0];
