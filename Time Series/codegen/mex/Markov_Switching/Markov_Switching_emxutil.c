 ...
 *
 * Code generation for function 'Markov_Switching_emxutil'
 *
 */
...
void emxFreeStruct_struct0_T(const emlrtStack *sp, struct0_T *pStruct)
{
  ...
  emxFree_real_T(sp, &pStruct->Pm);
  emxFree_real_T(sp, &pStruct->Sm);
  emxFree_real_T(sp, &pStruct->Yfm);
  emxFree_real_T(sp, &pStruct->Changepointm);
  emxFree_real_T(sp, &pStruct->lnML);
}
                             ...
                             const emlrtRTEInfo *srcLocation)
{
  ...
  emxInit_real_T(sp, &pStruct->Pm, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->Sm, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->Yfm, 1, srcLocation);
  emxInit_real_T(sp, &pStruct->Changepointm, 1, srcLocation);
  emxInit_real_T(sp, &pStruct->lnML, 1, srcLocation);
}
...
/* End of code generation (Markov_Switching_emxutil.c) */
