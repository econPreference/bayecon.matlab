...
real_T median(const emlrtStack *sp, const emxArray_real_T *x)
{
  ...
  if (x->size[0] == 0) {
    ...
    k = 0;
    emxInit_real_T(&st, &a__4, 1, &dg_emlrtRTEI);
    do {
      exitg1 = 0;
      if (k <= vlen - 1) {
        ...
        if (vlen <= 4) {
            ...
            if (x_data[k] < x_data[3]) {
              if (x_data[3] < x_data[vlen]) {
                if (((x_data[a__6] < 0.0) != (x_data[3] < 0.0)) ||
                    muDoubleScalarIsInf(x_data[a__6])) {
          ...
          if ((vlen & 1) == 0) {
            ...
            emxEnsureCapacity_real_T(&st, a__4, a__6, &cg_emlrtRTEI);
            a__4_data = a__4->data;
            k = x->size[0];
            ...
            a__6 = a__4->size[0];
            a__4->size[0] = x->size[0];
            emxEnsureCapacity_real_T(&st, a__4, a__6, &bg_emlrtRTEI);
            a__4_data = a__4->data;
            k = x->size[0];
            for (a__6 = 0; a__6 < k; a__6++) {
              a__4_data[a__6] = x_data[a__6];
