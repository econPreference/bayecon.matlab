...
static void d_feval(const emlrtStack *sp, const mxArray *m, const mxArray *m1,
...
void b_warning(const emlrtStack *sp, const char_T varargin_1[14])
{
  ...
  emlrtAssign(&d_y, m);
  st.site = &om_emlrtRSI;
  d_feval(&st, y, e_feval(&st, b_y, c_y, d_y, &u_emlrtMCI), &v_emlrtMCI);
}
...
void c_warning(const emlrtStack *sp)
{
  ...
  c_y = NULL;
  m = emlrtCreateCharArray(2, &iv2[0]);
  emlrtInitCharArrayR2013a((emlrtCTX)sp, 36, m, &msgID[0]);
  emlrtAssign(&c_y, m);
  st.site = &om_emlrtRSI;
  d_feval(&st, y, c_feval(&st, b_y, c_y, &u_emlrtMCI), &v_emlrtMCI);
}
               ...
               const char_T varargin_2[14])
{
  ...
  *(int32_T *)emlrtMxGetData(m) = varargin_1;
  ...
  emlrtAssign(&e_y, m);
  st.site = &om_emlrtRSI;
  d_feval(&st, y, feval(&st, b_y, c_y, d_y, e_y, &u_emlrtMCI), &v_emlrtMCI);
}
