...
MAKEFILE = Recursive_BVAR_mex.mk

include Recursive_BVAR_mex.mki
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\Recursive_BVAR"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\Recursive_BVAR/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
