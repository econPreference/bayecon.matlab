...
static emlrtRSInfo rd_emlrtRSI = { 172,/* lineNo */
...
static emlrtRTEInfo we_emlrtRTEI = { 95,/* lineNo */
  13,                                  /* colNo */
  "combineVectorElements",             /* fName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\datafun\\private\\combineVectorElements.m"/* pName */
};
  ...
  emxArray_real_T *y)
{
  ...
  if ((x->size[0] == 0) || (x->size[1] == 0)) {
    ...
    emxEnsureCapacity_real_T(sp, y, xpageoffset, &we_emlrtRTEI);
    i = (int32_T)sz[1];
    ...
    y->size[0] = 1;
    y->size[1] = x->size[1];
    emxEnsureCapacity_real_T(&st, y, xpageoffset, &ve_emlrtRTEI);
