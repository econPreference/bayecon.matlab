...
void b_error(const emlrtStack *sp, int32_T varargin_2)
{
  ...
  emlrtErrorWithMessageIdR2018a(sp, &jk_emlrtRTEI,
...
{
  emlrtErrorWithMessageIdR2018a(sp, &jk_emlrtRTEI, "MATLAB:nomem",
    "MATLAB:nomem", 0);
}
...
{
  emlrtErrorWithMessageIdR2018a(sp, &jk_emlrtRTEI, "MATLAB:gammaln:negativeVal",
