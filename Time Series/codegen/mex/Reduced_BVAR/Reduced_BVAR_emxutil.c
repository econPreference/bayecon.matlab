 ...
 *
 * Reduced_BVAR_emxutil.c
 *
 * Code generation for function 'Reduced_BVAR_emxutil'
 *
 */
...
{
  emxFree_real_T(sp, &pStruct->consm);
...
/* End of code generation (Reduced_BVAR_emxutil.c) */
