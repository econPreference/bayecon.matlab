...
MAKEFILE = Reduced_BVAR_mex.mk

include Reduced_BVAR_mex.mki


SRC_FILES =  \
	Reduced_BVAR_mexutil.c \
	Reduced_BVAR_data.c \
	Reduced_BVAR_initialize.c \
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\Reduced_BVAR"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\Reduced_BVAR/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
