...
static void emxInitStruct_cell_wrap_0(const emlrtStack *sp, cell_wrap_0 *pStruct,
  const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_real_T1(sp, &pStruct->f1, 2, srcLocation, doPush);
}
...
void emxEnsureCapacity_creal_T1(const emlrtStack *sp, emxArray_creal_T *emxArray,
  int32_T oldNumel, const emlrtRTEInfo *srcLocation)
{
  int32_T newNumel;
  int32_T i;
...
void emxEnsureCapacity_int32_T1(const emlrtStack *sp, emxArray_int32_T *emxArray,
  int32_T oldNumel, const emlrtRTEInfo *srcLocation)
{
  int32_T newNumel;
  int32_T i;
  ...
  *emxArray, int32_T oldNumel, const emlrtRTEInfo *srcLocation)
{
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    if (emxArray->data != NULL) {
      memcpy(newData, (void *)emxArray->data, sizeof(ptrdiff_t) * oldNumel);
      if (emxArray->canFreeData) {
        emlrtFreeMex((void *)emxArray->data);
      }
    }
...
{
  emxFree_real_T(&pStruct->Yfm);
  emxFree_real_T(&pStruct->Hm);
  emxFree_real_T(&pStruct->betam);
  emxFree_real_T(&pStruct->gammam);
  emxFree_real_T(&pStruct->Sig2m);
  emxFree_real_T(&pStruct->Volm);
}
...
void emxInitMatrix_cell_wrap_0(const emlrtStack *sp, cell_wrap_0 pMatrix[2],
  const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  int32_T i;
  for (i = 0; i < 2; i++) {
...
{
  emxInit_real_T(sp, &pStruct->Yfm, 1, srcLocation, doPush);
  emxInit_real_T1(sp, &pStruct->Hm, 2, srcLocation, doPush);
  emxInit_real_T1(sp, &pStruct->betam, 2, srcLocation, doPush);
  emxInit_real_T1(sp, &pStruct->gammam, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->Sig2m, 1, srcLocation, doPush);
  emxInit_real_T1(sp, &pStruct->Volm, 2, srcLocation, doPush);
}
...
/* End of code generation (Stochastic_Volatility_emxutil.c) */
