...
void assertValidSizeArg(const emlrtStack *sp, real_T varargin_1)
{
  ...
  if ((varargin_1 != varargin_1) || muDoubleScalarIsInf(varargin_1) ||
    ...
    emlrtErrorWithMessageIdR2018a(sp, &im_emlrtRTEI,
  ...
  if (!(b_varargin_1 <= 2.147483647E+9)) {
    emlrtErrorWithMessageIdR2018a(sp, &jm_emlrtRTEI, "Coder:MATLAB:pmaxsize",
