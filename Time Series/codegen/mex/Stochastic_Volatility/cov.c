...
static emlrtRSInfo sk_emlrtRSI = { 71, /* lineNo */
  "cov",                               /* fcnName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\datafun\\cov.m"/* pathName */
};

static emlrtRSInfo tk_emlrtRSI = { 73, /* lineNo */
  "cov",                               /* fcnName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\datafun\\cov.m"/* pathName */
};

static emlrtRSInfo uk_emlrtRSI = { 153,/* lineNo */
  "cov",                               /* fcnName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\datafun\\cov.m"/* pathName */
};

static emlrtRSInfo vk_emlrtRSI = { 158,/* lineNo */
  "cov",                               /* fcnName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\datafun\\cov.m"/* pathName */
};

static emlrtRSInfo wk_emlrtRSI = { 170,/* lineNo */
  "cov",                               /* fcnName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\datafun\\cov.m"/* pathName */
};

static emlrtRSInfo al_emlrtRSI = { 150,/* lineNo */
  "cov",                               /* fcnName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\datafun\\cov.m"/* pathName */
};

static emlrtRTEInfo yk_emlrtRTEI = { 73,/* lineNo */
  20,                                  /* colNo */
  "cov",                               /* fName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\datafun\\cov.m"/* pName */
};

static emlrtRTEInfo al_emlrtRTEI = { 71,/* lineNo */
  20,                                  /* colNo */
  "cov",                               /* fName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\datafun\\cov.m"/* pName */
};

static emlrtRTEInfo bl_emlrtRTEI = { 71,/* lineNo */
  5,                                   /* colNo */
  "cov",                               /* fName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\datafun\\cov.m"/* pName */
};
...
static emlrtRTEInfo dl_emlrtRTEI = { 105,/* lineNo */
  5,                                   /* colNo */
  "cov",                               /* fName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\datafun\\cov.m"/* pName */
};

static emlrtRTEInfo el_emlrtRTEI = { 169,/* lineNo */
  9,                                   /* colNo */
  "cov",                               /* fName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\datafun\\cov.m"/* pName */
};
                      ...
                      c)
{
  ...
  c->size[0] = x->size[1];
  c->size[1] = x->size[1];
  emxEnsureCapacity_real_T1(sp, c, nx, &cl_emlrtRTEI);
  ...
  if ((x->size[0] == 0) || (x->size[1] == 0)) {
    ...
    c->size[0] = x->size[1];
    c->size[1] = x->size[1];
    emxEnsureCapacity_real_T1(sp, c, nx, &dl_emlrtRTEI);
    loop_ub = x->size[1] * x->size[1];
    for (nx = 0; nx < loop_ub; nx++) {
      c->data[nx] = rtNaN;
    }
    ...
    if (x->size[0] >= 2) {
      ...
      c->size[0] = n;
      c->size[1] = n;
      emxEnsureCapacity_real_T1(sp, c, nx, &el_emlrtRTEI);
      loop_ub = n * n;
      for (nx = 0; nx < loop_ub; nx++) {
        c->data[nx] = 0.0;
      }
...
void cov(const emlrtStack *sp, const emxArray_real_T *x, emxArray_real_T *xy)
{
  ...
  overflow = (x->size[0] == 1);
  if (overflow) {
    emxInit_real_T(sp, &c_x, 1, &al_emlrtRTEI, true);
    st.site = &sk_emlrtRSI;
    LDA = x->size[1];
    m = c_x->size[0];
    c_x->size[0] = LDA;
    emxEnsureCapacity_real_T(&st, c_x, m, &al_emlrtRTEI);
    for (m = 0; m < LDA; m++) {
    ...
    xy->size[0] = 1;
    xy->size[1] = 1;
    emxEnsureCapacity_real_T1(sp, xy, m, &bl_emlrtRTEI);
    xy->data[0] = c;
  } else {
    emxInit_real_T1(sp, &b_x, 2, &yk_emlrtRTEI, true);
    m = b_x->size[0] * b_x->size[1];
    b_x->size[0] = x->size[0];
    b_x->size[1] = x->size[1];
    emxEnsureCapacity_real_T1(sp, b_x, m, &yk_emlrtRTEI);
