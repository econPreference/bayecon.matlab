...
static emlrtRSInfo jk_emlrtRSI = { 10, /* lineNo */
  "gammaln",                           /* fcnName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\specfun\\gammaln.m"/* pathName */
};

static emlrtRSInfo kk_emlrtRSI = { 15, /* lineNo */
  "applyScalarFunctionInPlace",        /* fcnName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\eml\\+coder\\+internal\\applyScalarFunctionInPlace.m"/* pathName */
};

static emlrtRSInfo lk_emlrtRSI = { 117,/* lineNo */
  "gammaln",                           /* fcnName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\specfun\\gammaln.m"/* pathName */
};

static emlrtRSInfo mk_emlrtRSI = { 121,/* lineNo */
  "gammaln",                           /* fcnName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\specfun\\gammaln.m"/* pathName */
};

static emlrtRSInfo nk_emlrtRSI = { 129,/* lineNo */
  "gammaln",                           /* fcnName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\specfun\\gammaln.m"/* pathName */
};

static emlrtRSInfo ok_emlrtRSI = { 138,/* lineNo */
  "gammaln",                           /* fcnName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\specfun\\gammaln.m"/* pathName */
};

static emlrtRSInfo pk_emlrtRSI = { 179,/* lineNo */
  "gammaln",                           /* fcnName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\specfun\\gammaln.m"/* pathName */
};
...
void gammaln(const emlrtStack *sp, real_T *x)
{
  ...
  if (!muDoubleScalarIsNaN(*x)) {
    if (*x < 0.0) {
      ...
      *x = -muDoubleScalarLog(*x) + *x * (-0.57721566490153287 + *x * (r / t));
    } else if (*x <= 0.6796875) {
      t = 1.0;
      r = 0.0;
      for (i = 0; i < 8; i++) {
      ...
      *x = -muDoubleScalarLog(*x) + ((*x - 0.5) - 0.5) * (0.42278433509846713 +
        ((*x - 0.5) - 0.5) * (r / t));
    } else if ((*x == muDoubleScalarFloor(*x)) && (*x <= 100.0)) {
      *x = table100[(int32_T)*x - 1];
    } else if (*x <= 1.5) {
      t = 1.0;
      r = 0.0;
      for (i = 0; i < 8; i++) {
