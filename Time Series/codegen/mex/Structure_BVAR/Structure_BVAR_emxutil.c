 ...
 *
 * Code generation for function 'Structure_BVAR_emxutil'
 *
 */
...
{
  emxFree_real_T(sp, &pStruct->Bm);
  emxFree_real_T(sp, &pStruct->Gammam);
  emxFree_real_T(sp, &pStruct->ImpulseRespm);
...
void emxInitStruct_struct0_T(const emlrtStack *sp, struct0_T *pStruct,
                             const emlrtRTEInfo *srcLocation)
{
  emxInit_real_T(sp, &pStruct->Bm, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->Gammam, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->ImpulseRespm, 3, srcLocation);
  emxInit_real_T(sp, &pStruct->decomm, 3, srcLocation);
...
/* End of code generation (Structure_BVAR_emxutil.c) */
