...
void cholesky(const emlrtStack *sp, emxArray_real_T *A)
{
  ...
  if (A->size[0] != A->size[1]) {
    emlrtErrorWithMessageIdR2018a(sp, &ib_emlrtRTEI, "Coder:MATLAB:square",
  ...
  if (A->size[1] != 0) {
    ...
    if (info < 0) {
      if (info == -1010) {
        ...
        emlrtErrorWithMessageIdR2018a(
            &c_st, &w_emlrtRTEI, "Coder:toolbox:LAPACKCallErrorInfo",
    ...
    if (info == 0) {
      ...
      emlrtErrorWithMessageIdR2018a(sp, &jb_emlrtRTEI, "Coder:MATLAB:posdef",
