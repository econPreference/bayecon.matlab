...
void schur(const emlrtStack *sp, emxArray_real_T *A)
{
  ...
  if (A->size[0] != A->size[1]) {
    emlrtErrorWithMessageIdR2018a(sp, &kb_emlrtRTEI, "Coder:MATLAB:square",
  ...
  if (anyNonFinite(&st, A)) {
    ...
    A->size[0] = A_idx_1;
    A->size[1] = n;
    emxEnsureCapacity_real_T(sp, A, i, &ki_emlrtRTEI);
    A_data = A->data;
    for (i = 0; i < n; i++) {
      for (j = 0; j < A_idx_1; j++) {
    ...
    emxInit_real_T(sp, &tau, 1, &qi_emlrtRTEI);
    st.site = &ig_emlrtRSI;
    ...
    emxEnsureCapacity_real_T(&b_st, tau, i, &li_emlrtRTEI);
    wr_data = tau->data;
    if (A->size[0] > 1) {
      ...
      if (p) {
        ...
        A->size[0] = istart;
        A->size[1] = A_idx_1;
        emxEnsureCapacity_real_T(&b_st, A, i, &ni_emlrtRTEI);
        A_data = A->data;
        for (i = 0; i < A_idx_1; i++) {
          for (j = 0; j < istart; j++) {
            A_data[j + A->size[0] * i] = rtNaN;
    ...
    if ((A->size[0] != 0) && (A->size[1] != 0)) {
      emxInit_real_T(&b_st, &wr, 2, &ri_emlrtRTEI);
      emxInit_real_T(&b_st, &wi, 2, &si_emlrtRTEI);
      A_idx_1 = A->size[0];
      i = wr->size[0] * wr->size[1];
      wr->size[0] = 1;
      wr->size[1] = A_idx_1;
      emxEnsureCapacity_real_T(&b_st, wr, i, &mi_emlrtRTEI);
      wr_data = wr->data;
      i = wi->size[0] * wi->size[1];
      wi->size[0] = 1;
      wi->size[1] = A_idx_1;
      emxEnsureCapacity_real_T(&b_st, wi, i, &oi_emlrtRTEI);
      wi_data = wi->data;
      ...
      if (p) {
        ...
        A->size[0] = istart;
        A->size[1] = A_idx_1;
        emxEnsureCapacity_real_T(&b_st, A, i, &pi_emlrtRTEI);
        A_data = A->data;
        for (i = 0; i < A_idx_1; i++) {
          for (j = 0; j < istart; j++) {
            A_data[j + A->size[0] * i] = rtNaN;
