...
void b_warning(const emlrtStack *sp, const char_T varargin_1[14])
{
  ...
  emlrtAssign(&d_y, m);
  st.site = &tl_emlrtRSI;
  b_feval(&st, y, c_feval(&st, b_y, c_y, d_y, &o_emlrtMCI), &p_emlrtMCI);
}
...
void c_warning(const emlrtStack *sp)
{
  ...
  emlrtAssign(&c_y, m);
  st.site = &tl_emlrtRSI;
  b_feval(&st, y, feval(&st, b_y, c_y, &o_emlrtMCI), &p_emlrtMCI);
}
...
void e_warning(const emlrtStack *sp, int32_T varargin_1,
               const char_T varargin_2[14])
{
  ...
  *(int32_T *)emlrtMxGetData(m) = varargin_1;
  ...
  emlrtAssign(&e_y, m);
  st.site = &tl_emlrtRSI;
  b_feval(&st, y, d_feval(&st, b_y, c_y, d_y, e_y, &o_emlrtMCI), &p_emlrtMCI);
}
