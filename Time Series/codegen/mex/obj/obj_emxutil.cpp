 ...
 * obj_emxutil.cpp
 *
 * Code generation for function 'obj_emxutil'
 *
 */
  ...
  int32_T oldNumel, const emlrtRTEInfo *srcLocation)
{
  ...
  for (i = 0; i < emxArray->numDimensions; i++) {
    newNumel = static_cast<int32_T>(emlrtSizeMulR2012b((uint32_T)newNumel,
      (uint32_T)emxArray->size[i], (emlrtRTEInfo *)srcLocation, sp));
  }
...
/* End of code generation (obj_emxutil.cpp) */
