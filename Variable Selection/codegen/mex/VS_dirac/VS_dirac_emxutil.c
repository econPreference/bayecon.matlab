 ...
 * VS_dirac_emxutil.c
 *
 * Code generation for function 'VS_dirac_emxutil'
 *
 */
...
void emxFreeStruct_struct0_T(const emlrtStack *sp, struct0_T *pStruct)
{
  ...
  emxFree_real_T(sp, &pStruct->alpham);
...
void emxInitStruct_struct0_T(const emlrtStack *sp, struct0_T *pStruct,
                             const emlrtRTEInfo *srcLocation)
{
  emxInit_real_T(sp, &pStruct->omegam, 1, srcLocation);
  emxInit_real_T(sp, &pStruct->alpham, 2, srcLocation);
...
/* End of code generation (VS_dirac_emxutil.c) */
