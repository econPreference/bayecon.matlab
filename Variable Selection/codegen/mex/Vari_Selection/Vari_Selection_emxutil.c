 ...
 *
 * Vari_Selection_emxutil.c
 *
 * Code generation for function 'Vari_Selection_emxutil'
 *
 */
...
void emxFreeStruct_struct0_T(const emlrtStack *sp, struct0_T *pStruct)
{
  ...
  emxFree_real_T(sp, &pStruct->sigma2m);
                             ...
                             const emlrtRTEInfo *srcLocation)
{
  ...
  emxInit_real_T(sp, &pStruct->sigma2m, 1, srcLocation);
...
/* End of code generation (Vari_Selection_emxutil.c) */
