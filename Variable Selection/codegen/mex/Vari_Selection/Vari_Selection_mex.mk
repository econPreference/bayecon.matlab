START_DIR = C:\Users\smith\DOCUME~1\MATLAB\Bayecon\VARIAB~1

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2018a
MAKEFILE = Vari_Selection_mex.mk

include Vari_Selection_mex.mki


SRC_FILES =  \
	Vari_Selection_mexutil.c \
	Vari_Selection_data.c \
	Vari_Selection_initialize.c \
	Vari_Selection_terminate.c \
	Vari_Selection.c \
	stdc.c \
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\Vari_Selection"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\Vari_Selection/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
